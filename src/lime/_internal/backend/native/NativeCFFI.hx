...
class NativeCFFI
{
	//<<JNI_FORWARDERS_BEGIN>> (generated by jni-gen/GenJNI.hx — re-run to refresh; do not hand-edit)
	#if lime_jni
	// === AUTO-GENERATED by jni-gen/GenJNI.hx — do not edit by hand ===
	// Forwarders to lime.jni.Lime (JNI). Signatures mirror the cpp @:cffi block
	// so all backend call sites type-check. Non-primitives flow as Dynamic/Object.
	public static inline function lime_al_auxf(aux:CFFIPointer, param:Int, value:Float32):Void { lime.jni.Lime.lime_al_auxf(aux, param, value); }
	public static inline function lime_al_auxfv(aux:CFFIPointer, param:Int, values:Array<Float>):Void { lime.jni.Lime.lime_al_auxfv(aux, param, values); }
	public static inline function lime_al_auxi(aux:CFFIPointer, param:Int, value:Dynamic):Void { lime.jni.Lime.lime_al_auxi(aux, param, value); }
	public static inline function lime_al_auxiv(aux:CFFIPointer, param:Int, values:Array<Int>):Void { lime.jni.Lime.lime_al_auxiv(aux, param, values); }
	public static inline function lime_al_buffer3f(buffer:CFFIPointer, param:Int, value1:Float32, value2:Float32, value3:Float32):Void { lime.jni.Lime.lime_al_buffer3f(buffer, param, value1, value2, value3); }
	public static inline function lime_al_buffer3i(buffer:CFFIPointer, param:Int, value1:Int, value2:Int, value3:Int):Void { lime.jni.Lime.lime_al_buffer3i(buffer, param, value1, value2, value3); }
	public static inline function lime_al_buffer_data(buffer:CFFIPointer, format:Int, data:Dynamic, size:Int, freq:Int):Void { lime.jni.Lime.lime_al_buffer_data(buffer, format, data, size, freq); }
	public static inline function lime_al_bufferf(buffer:CFFIPointer, param:Int, value:Float32):Void { lime.jni.Lime.lime_al_bufferf(buffer, param, value); }
	public static inline function lime_al_bufferfv(buffer:CFFIPointer, param:Int, values:Dynamic):Void { lime.jni.Lime.lime_al_bufferfv(buffer, param, values); }
	public static inline function lime_al_bufferi(buffer:CFFIPointer, param:Int, value:Int):Void { lime.jni.Lime.lime_al_bufferi(buffer, param, value); }
	public static inline function lime_al_bufferiv(buffer:CFFIPointer, param:Int, values:Dynamic):Void { lime.jni.Lime.lime_al_bufferiv(buffer, param, values); }
	public static inline function lime_al_cleanup():Void { lime.jni.Lime.lime_al_cleanup(); }
	public static inline function lime_al_delete_buffer(buffer:CFFIPointer):Void { lime.jni.Lime.lime_al_delete_buffer(buffer); }
	public static inline function lime_al_delete_buffers(n:Int, buffers:Dynamic):Void { lime.jni.Lime.lime_al_delete_buffers(n, buffers); }
	public static inline function lime_al_delete_source(source:CFFIPointer):Void { lime.jni.Lime.lime_al_delete_source(source); }
	public static inline function lime_al_delete_sources(n:Int, sources:Dynamic):Void { lime.jni.Lime.lime_al_delete_sources(n, sources); }
	public static inline function lime_al_disable(capability:Int):Void { lime.jni.Lime.lime_al_disable(capability); }
	public static inline function lime_al_distance_model(distanceModel:Int):Void { lime.jni.Lime.lime_al_distance_model(distanceModel); }
	public static inline function lime_al_doppler_factor(value:Float32):Void { lime.jni.Lime.lime_al_doppler_factor(value); }
	public static inline function lime_al_doppler_velocity(value:Float32):Void { lime.jni.Lime.lime_al_doppler_velocity(value); }
	public static inline function lime_al_effectf(effect:CFFIPointer, param:Int, value:Float32):Void { lime.jni.Lime.lime_al_effectf(effect, param, value); }
	public static inline function lime_al_effectfv(effect:CFFIPointer, param:Int, values:Array<Float>):Void { lime.jni.Lime.lime_al_effectfv(effect, param, values); }
	public static inline function lime_al_effecti(effect:CFFIPointer, param:Int, value:Int):Void { lime.jni.Lime.lime_al_effecti(effect, param, value); }
	public static inline function lime_al_effectiv(effect:CFFIPointer, param:Int, values:Array<Int>):Void { lime.jni.Lime.lime_al_effectiv(effect, param, values); }
	public static inline function lime_al_enable(capability:Int):Void { lime.jni.Lime.lime_al_enable(capability); }
	public static inline function lime_al_filterf(filter:CFFIPointer, param:Int, value:Float32):Void { lime.jni.Lime.lime_al_filterf(filter, param, value); }
	public static inline function lime_al_filteri(filter:CFFIPointer, param:Int, value:Dynamic):Void { lime.jni.Lime.lime_al_filteri(filter, param, value); }
	public static inline function lime_al_gen_aux():CFFIPointer { return cast lime.jni.Lime.lime_al_gen_aux(); }
	public static inline function lime_al_gen_buffer():CFFIPointer { return cast lime.jni.Lime.lime_al_gen_buffer(); }
	public static inline function lime_al_gen_buffers(n:Int):Array<CFFIPointer> { return cast lime.jni.Lime.lime_al_gen_buffers(n); }
	public static inline function lime_al_gen_effect():CFFIPointer { return cast lime.jni.Lime.lime_al_gen_effect(); }
	public static inline function lime_al_gen_filter():CFFIPointer { return cast lime.jni.Lime.lime_al_gen_filter(); }
	public static inline function lime_al_gen_source():CFFIPointer { return cast lime.jni.Lime.lime_al_gen_source(); }
	public static inline function lime_al_gen_sources(n:Int):Array<CFFIPointer> { return cast lime.jni.Lime.lime_al_gen_sources(n); }
	public static inline function lime_al_get_boolean(param:Int):Bool { return lime.jni.Lime.lime_al_get_boolean(param); }
	public static inline function lime_al_get_booleanv(param:Int, count:Int):Array<Bool> { return cast lime.jni.Lime.lime_al_get_booleanv(param, count); }
	public static inline function lime_al_get_buffer3f(buffer:CFFIPointer, param:Int):Array<Float> { return cast lime.jni.Lime.lime_al_get_buffer3f(buffer, param); }
	public static inline function lime_al_get_buffer3i(buffer:CFFIPointer, param:Int):Array<Int> { return cast lime.jni.Lime.lime_al_get_buffer3i(buffer, param); }
	public static inline function lime_al_get_bufferf(buffer:CFFIPointer, param:Int):Float32 { return lime.jni.Lime.lime_al_get_bufferf(buffer, param); }
	public static inline function lime_al_get_bufferfv(buffer:CFFIPointer, param:Int, count:Int):Array<Float> { return cast lime.jni.Lime.lime_al_get_bufferfv(buffer, param, count); }
	public static inline function lime_al_get_bufferi(buffer:CFFIPointer, param:Int):Int { return lime.jni.Lime.lime_al_get_bufferi(buffer, param); }
	public static inline function lime_al_get_bufferiv(buffer:CFFIPointer, param:Int, count:Int):Array<Int> { return cast lime.jni.Lime.lime_al_get_bufferiv(buffer, param, count); }
	public static inline function lime_al_get_double(param:Int):Float { return lime.jni.Lime.lime_al_get_double(param); }
	public static inline function lime_al_get_doublev(param:Int, count:Int):Array<Float> { return cast lime.jni.Lime.lime_al_get_doublev(param, count); }
	public static inline function lime_al_get_enum_value(ename:String):Int { return lime.jni.Lime.lime_al_get_enum_value(ename); }
	public static inline function lime_al_get_error():Int { return lime.jni.Lime.lime_al_get_error(); }
	public static inline function lime_al_get_filteri(filter:CFFIPointer, param:Int):Int { return lime.jni.Lime.lime_al_get_filteri(filter, param); }
	public static inline function lime_al_get_float(param:Int):Float32 { return lime.jni.Lime.lime_al_get_float(param); }
	public static inline function lime_al_get_floatv(param:Int, count:Int):Array<Float> { return cast lime.jni.Lime.lime_al_get_floatv(param, count); }
	public static inline function lime_al_get_integer(param:Int):Int { return lime.jni.Lime.lime_al_get_integer(param); }
	public static inline function lime_al_get_integerv(param:Int, count:Int):Array<Int> { return cast lime.jni.Lime.lime_al_get_integerv(param, count); }
	public static inline function lime_al_get_listener3f(param:Int):Array<Float> { return cast lime.jni.Lime.lime_al_get_listener3f(param); }
	public static inline function lime_al_get_listener3i(param:Int):Array<Int> { return cast lime.jni.Lime.lime_al_get_listener3i(param); }
	public static inline function lime_al_get_listenerf(param:Int):Float32 { return lime.jni.Lime.lime_al_get_listenerf(param); }
	public static inline function lime_al_get_listenerfv(param:Int, count:Int):Array<Float> { return cast lime.jni.Lime.lime_al_get_listenerfv(param, count); }
	public static inline function lime_al_get_listeneri(param:Int):Int { return lime.jni.Lime.lime_al_get_listeneri(param); }
	public static inline function lime_al_get_listeneriv(param:Int, count:Int):Array<Int> { return cast lime.jni.Lime.lime_al_get_listeneriv(param, count); }
	public static inline function lime_al_get_proc_address(fname:String):Float { return lime.jni.Lime.lime_al_get_proc_address(fname); }
	public static inline function lime_al_get_source3f(source:CFFIPointer, param:Int):Array<Float> { return cast lime.jni.Lime.lime_al_get_source3f(source, param); }
	public static inline function lime_al_get_source3i(source:CFFIPointer, param:Int):Array<Int> { return cast lime.jni.Lime.lime_al_get_source3i(source, param); }
	public static inline function lime_al_get_sourcef(source:CFFIPointer, param:Int):Float32 { return lime.jni.Lime.lime_al_get_sourcef(source, param); }
	public static inline function lime_al_get_sourcefv(source:CFFIPointer, param:Int, count:Int):Array<Float> { return cast lime.jni.Lime.lime_al_get_sourcefv(source, param, count); }
	public static inline function lime_al_get_sourcei(source:CFFIPointer, param:Int):Dynamic { return cast lime.jni.Lime.lime_al_get_sourcei(source, param); }
	public static inline function lime_al_get_sourceiv(source:CFFIPointer, param:Int, count:Int):Array<Int> { return cast lime.jni.Lime.lime_al_get_sourceiv(source, param, count); }
	public static inline function lime_al_get_string(param:Int):Dynamic { return cast lime.jni.Lime.lime_al_get_string(param); }
	public static inline function lime_al_is_aux(aux:CFFIPointer):Bool { return lime.jni.Lime.lime_al_is_aux(aux); }
	public static inline function lime_al_is_buffer(buffer:CFFIPointer):Bool { return lime.jni.Lime.lime_al_is_buffer(buffer); }
	public static inline function lime_al_is_effect(effect:CFFIPointer):Bool { return lime.jni.Lime.lime_al_is_effect(effect); }
	public static inline function lime_al_is_enabled(capability:Int):Bool { return lime.jni.Lime.lime_al_is_enabled(capability); }
	public static inline function lime_al_is_extension_present(extname:String):Bool { return lime.jni.Lime.lime_al_is_extension_present(extname); }
	public static inline function lime_al_is_filter(filter:CFFIPointer):Bool { return lime.jni.Lime.lime_al_is_filter(filter); }
	public static inline function lime_al_is_source(source:CFFIPointer):Bool { return lime.jni.Lime.lime_al_is_source(source); }
	public static inline function lime_al_listener3f(param:Int, value1:Float32, value2:Float32, value3:Float32):Void { lime.jni.Lime.lime_al_listener3f(param, value1, value2, value3); }
	public static inline function lime_al_listener3i(param:Int, value1:Int, value2:Int, value3:Int):Void { lime.jni.Lime.lime_al_listener3i(param, value1, value2, value3); }
	public static inline function lime_al_listenerf(param:Int, value1:Float32):Void { lime.jni.Lime.lime_al_listenerf(param, value1); }
	public static inline function lime_al_listenerfv(param:Int, values:Dynamic):Void { lime.jni.Lime.lime_al_listenerfv(param, values); }
	public static inline function lime_al_listeneri(param:Int, value1:Int):Void { lime.jni.Lime.lime_al_listeneri(param, value1); }
	public static inline function lime_al_listeneriv(param:Int, values:Dynamic):Void { lime.jni.Lime.lime_al_listeneriv(param, values); }
	public static inline function lime_al_remove_direct_filter(source:CFFIPointer):Void { lime.jni.Lime.lime_al_remove_direct_filter(source); }
	public static inline function lime_al_remove_send(source:CFFIPointer, index:Int):Void { lime.jni.Lime.lime_al_remove_send(source, index); }
	public static inline function lime_al_source3f(source:CFFIPointer, param:Int, value1:Float32, value2:Float32, value3:Float32):Void { lime.jni.Lime.lime_al_source3f(source, param, value1, value2, value3); }
	public static inline function lime_al_source3i(source:CFFIPointer, param:Int, value1:Dynamic, value2:Int, value3:Int):Void { lime.jni.Lime.lime_al_source3i(source, param, value1, value2, value3); }
	public static inline function lime_al_source_pause(source:CFFIPointer):Void { lime.jni.Lime.lime_al_source_pause(source); }
	public static inline function lime_al_source_pausev(n:Int, sources:Dynamic):Void { lime.jni.Lime.lime_al_source_pausev(n, sources); }
	public static inline function lime_al_source_play(source:CFFIPointer):Void { lime.jni.Lime.lime_al_source_play(source); }
	public static inline function lime_al_source_playv(n:Int, sources:Dynamic):Void { lime.jni.Lime.lime_al_source_playv(n, sources); }
	public static inline function lime_al_source_queue_buffers(source:CFFIPointer, nb:Int, buffers:Dynamic):Void { lime.jni.Lime.lime_al_source_queue_buffers(source, nb, buffers); }
	public static inline function lime_al_source_rewind(source:CFFIPointer):Void { lime.jni.Lime.lime_al_source_rewind(source); }
	public static inline function lime_al_source_rewindv(n:Int, sources:Dynamic):Void { lime.jni.Lime.lime_al_source_rewindv(n, sources); }
	public static inline function lime_al_source_stop(source:CFFIPointer):Void { lime.jni.Lime.lime_al_source_stop(source); }
	public static inline function lime_al_source_stopv(n:Int, sources:Dynamic):Void { lime.jni.Lime.lime_al_source_stopv(n, sources); }
	public static inline function lime_al_source_unqueue_buffers(source:CFFIPointer, nb:Int):Dynamic { return cast lime.jni.Lime.lime_al_source_unqueue_buffers(source, nb); }
	public static inline function lime_al_sourcef(source:CFFIPointer, param:Int, value:Float32):Void { lime.jni.Lime.lime_al_sourcef(source, param, value); }
	public static inline function lime_al_sourcefv(source:CFFIPointer, param:Int, values:Dynamic):Void { lime.jni.Lime.lime_al_sourcefv(source, param, values); }
	public static inline function lime_al_sourcei(source:CFFIPointer, param:Int, value:Dynamic):Void { lime.jni.Lime.lime_al_sourcei(source, param, value); }
	public static inline function lime_al_sourceiv(source:CFFIPointer, param:Int, values:Dynamic):Void { lime.jni.Lime.lime_al_sourceiv(source, param, values); }
	public static inline function lime_al_speed_of_sound(speed:Float32):Void { lime.jni.Lime.lime_al_speed_of_sound(speed); }
	public static inline function lime_alc_close_device(device:CFFIPointer):Bool { return lime.jni.Lime.lime_alc_close_device(device); }
	public static inline function lime_alc_create_context(device:CFFIPointer, attrlist:Dynamic):CFFIPointer { return cast lime.jni.Lime.lime_alc_create_context(device, attrlist); }
	public static inline function lime_alc_destroy_context(context:CFFIPointer):Void { lime.jni.Lime.lime_alc_destroy_context(context); }
	public static inline function lime_alc_get_contexts_device(context:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_alc_get_contexts_device(context); }
	public static inline function lime_alc_get_current_context():CFFIPointer { return cast lime.jni.Lime.lime_alc_get_current_context(); }
	public static inline function lime_alc_get_error(device:CFFIPointer):Int { return lime.jni.Lime.lime_alc_get_error(device); }
	public static inline function lime_alc_get_integerv(device:CFFIPointer, param:Int, size:Int):Dynamic { return cast lime.jni.Lime.lime_alc_get_integerv(device, param, size); }
	public static inline function lime_alc_get_string(device:CFFIPointer, param:Int):Dynamic { return cast lime.jni.Lime.lime_alc_get_string(device, param); }
	public static inline function lime_alc_make_context_current(context:CFFIPointer):Bool { return lime.jni.Lime.lime_alc_make_context_current(context); }
	public static inline function lime_alc_open_device(devicename:String):CFFIPointer { return cast lime.jni.Lime.lime_alc_open_device(devicename); }
	public static inline function lime_alc_pause_device(device:CFFIPointer):Void { lime.jni.Lime.lime_alc_pause_device(device); }
	public static inline function lime_alc_process_context(context:CFFIPointer):Void { lime.jni.Lime.lime_alc_process_context(context); }
	public static inline function lime_alc_resume_device(device:CFFIPointer):Void { lime.jni.Lime.lime_alc_resume_device(device); }
	public static inline function lime_alc_suspend_context(context:CFFIPointer):Void { lime.jni.Lime.lime_alc_suspend_context(context); }
	public static inline function lime_application_create():Dynamic { return cast lime.jni.Lime.lime_application_create(); }
	public static inline function lime_application_event_manager_register(callback:Dynamic, eventObject:Dynamic):Void { lime.jni.Lime.lime_application_event_manager_register(callback, eventObject); }
	public static inline function lime_application_exec(handle:Dynamic):Int { return lime.jni.Lime.lime_application_exec(handle); }
	public static inline function lime_application_init(handle:Dynamic):Void { lime.jni.Lime.lime_application_init(handle); }
	public static inline function lime_application_quit(handle:Dynamic):Int { return lime.jni.Lime.lime_application_quit(handle); }
	public static inline function lime_application_set_frame_rate(handle:Dynamic, value:Float):Void { lime.jni.Lime.lime_application_set_frame_rate(handle, value); }
	public static inline function lime_application_set_main_loop(handle:Dynamic, profile:Int, frameRate:Float, timePrecision:Int, busyWait:Int, uncapMode:Int):Void { lime.jni.Lime.lime_application_set_main_loop(handle, profile, frameRate, timePrecision, busyWait, uncapMode); }
	public static inline function lime_application_set_vsync_mode(handle:Dynamic, value:Int):Void { lime.jni.Lime.lime_application_set_vsync_mode(handle, value); }
	public static inline function lime_application_update(handle:Dynamic):Bool { return lime.jni.Lime.lime_application_update(handle); }
	public static inline function lime_audio_load(data:Dynamic, buffer:Dynamic):Dynamic { return cast lime.jni.Lime.lime_audio_load(data, buffer); }
	public static inline function lime_audio_load_bytes(data:Dynamic, buffer:Dynamic):Dynamic { return cast lime.jni.Lime.lime_audio_load_bytes(data, buffer); }
	public static inline function lime_audio_load_file(path:Dynamic, buffer:Dynamic):Dynamic { return cast lime.jni.Lime.lime_audio_load_file(path, buffer); }
	public static inline function lime_bytes_from_data_pointer(data:Float, length:Int, bytes:Dynamic):Dynamic { return cast lime.jni.Lime.lime_bytes_from_data_pointer(data, length, bytes); }
	public static inline function lime_bytes_get_data_pointer(data:Dynamic):Float { return lime.jni.Lime.lime_bytes_get_data_pointer(data); }
	public static inline function lime_bytes_get_data_pointer_offset(data:Dynamic, offset:Int):Float { return lime.jni.Lime.lime_bytes_get_data_pointer_offset(data, offset); }
	public static inline function lime_bytes_read_file(path:String, bytes:Dynamic):Dynamic { return cast lime.jni.Lime.lime_bytes_read_file(path, bytes); }
	public static inline function lime_cairo_arc(handle:CFFIPointer, xc:Float, yc:Float, radius:Float, angle1:Float, angle2:Float):Void { lime.jni.Lime.lime_cairo_arc(handle, xc, yc, radius, angle1, angle2); }
	public static inline function lime_cairo_arc_negative(handle:CFFIPointer, xc:Float, yc:Float, radius:Float, angle1:Float, angle2:Float):Void { lime.jni.Lime.lime_cairo_arc_negative(handle, xc, yc, radius, angle1, angle2); }
	public static inline function lime_cairo_clip(handle:CFFIPointer):Void { lime.jni.Lime.lime_cairo_clip(handle); }
	public static inline function lime_cairo_clip_extents(handle:CFFIPointer, x1:Float, y1:Float, x2:Float, y2:Float):Void { lime.jni.Lime.lime_cairo_clip_extents(handle, x1, y1, x2, y2); }
	public static inline function lime_cairo_clip_preserve(handle:CFFIPointer):Void { lime.jni.Lime.lime_cairo_clip_preserve(handle); }
	public static inline function lime_cairo_close_path(handle:CFFIPointer):Void { lime.jni.Lime.lime_cairo_close_path(handle); }
	public static inline function lime_cairo_copy_page(handle:CFFIPointer):Void { lime.jni.Lime.lime_cairo_copy_page(handle); }
	public static inline function lime_cairo_create(handle:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_cairo_create(handle); }
	public static inline function lime_cairo_curve_to(handle:CFFIPointer, x1:Float, y1:Float, x2:Float, y2:Float, x3:Float, y3:Float):Void { lime.jni.Lime.lime_cairo_curve_to(handle, x1, y1, x2, y2, x3, y3); }
	public static inline function lime_cairo_fill(handle:CFFIPointer):Void { lime.jni.Lime.lime_cairo_fill(handle); }
	public static inline function lime_cairo_fill_extents(handle:CFFIPointer, x1:Float, y1:Float, x2:Float, y2:Float):Void { lime.jni.Lime.lime_cairo_fill_extents(handle, x1, y1, x2, y2); }
	public static inline function lime_cairo_fill_preserve(handle:CFFIPointer):Void { lime.jni.Lime.lime_cairo_fill_preserve(handle); }
	public static inline function lime_cairo_font_face_status(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_font_face_status(handle); }
	public static inline function lime_cairo_font_options_create():CFFIPointer { return cast lime.jni.Lime.lime_cairo_font_options_create(); }
	public static inline function lime_cairo_font_options_get_antialias(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_font_options_get_antialias(handle); }
	public static inline function lime_cairo_font_options_get_hint_metrics(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_font_options_get_hint_metrics(handle); }
	public static inline function lime_cairo_font_options_get_hint_style(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_font_options_get_hint_style(handle); }
	public static inline function lime_cairo_font_options_get_subpixel_order(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_font_options_get_subpixel_order(handle); }
	public static inline function lime_cairo_font_options_set_antialias(handle:CFFIPointer, v:Int):Void { lime.jni.Lime.lime_cairo_font_options_set_antialias(handle, v); }
	public static inline function lime_cairo_font_options_set_hint_metrics(handle:CFFIPointer, v:Int):Void { lime.jni.Lime.lime_cairo_font_options_set_hint_metrics(handle, v); }
	public static inline function lime_cairo_font_options_set_hint_style(handle:CFFIPointer, v:Int):Void { lime.jni.Lime.lime_cairo_font_options_set_hint_style(handle, v); }
	public static inline function lime_cairo_font_options_set_subpixel_order(handle:CFFIPointer, v:Int):Void { lime.jni.Lime.lime_cairo_font_options_set_subpixel_order(handle, v); }
	public static inline function lime_cairo_ft_font_face_create(face:CFFIPointer, flags:Int):CFFIPointer { return cast lime.jni.Lime.lime_cairo_ft_font_face_create(face, flags); }
	public static inline function lime_cairo_get_antialias(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_get_antialias(handle); }
	public static inline function lime_cairo_get_current_point(handle:CFFIPointer):Dynamic
	{
		#if wasmjs
		// wasm can't build Haxe anons: rebuild {x,y} here from the indexed-scalar bridge
		return {x: lime.jni.Lime.lime_cairo_get_current_point_d(handle, 0), y: lime.jni.Lime.lime_cairo_get_current_point_d(handle, 1)};
		#else
		return cast lime.jni.Lime.lime_cairo_get_current_point(handle);
		#end
	}
	public static inline function lime_cairo_get_dash(handle:CFFIPointer):Dynamic { return cast lime.jni.Lime.lime_cairo_get_dash(handle); }
	public static inline function lime_cairo_get_dash_count(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_get_dash_count(handle); }
	public static inline function lime_cairo_get_fill_rule(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_get_fill_rule(handle); }
	public static inline function lime_cairo_get_font_face(handle:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_cairo_get_font_face(handle); }
	public static inline function lime_cairo_get_font_options(handle:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_cairo_get_font_options(handle); }
	public static inline function lime_cairo_get_group_target(handle:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_cairo_get_group_target(handle); }
	public static inline function lime_cairo_get_line_cap(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_get_line_cap(handle); }
	public static inline function lime_cairo_get_line_join(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_get_line_join(handle); }
	public static inline function lime_cairo_get_line_width(handle:CFFIPointer):Float { return lime.jni.Lime.lime_cairo_get_line_width(handle); }
	public static inline function lime_cairo_get_matrix(handle:CFFIPointer):Dynamic
	{
		#if wasmjs
		// MUST be a real lime.math.Matrix3 (abstract over Float32Array — callers read a..ty as
		// inline this[0..5] getters); an anon {a:..} here NPEs the first bitmap-fill render.
		return new lime.math.Matrix3(
			lime.jni.Lime.lime_cairo_get_matrix_d(handle, 0), lime.jni.Lime.lime_cairo_get_matrix_d(handle, 1),
			lime.jni.Lime.lime_cairo_get_matrix_d(handle, 2), lime.jni.Lime.lime_cairo_get_matrix_d(handle, 3),
			lime.jni.Lime.lime_cairo_get_matrix_d(handle, 4), lime.jni.Lime.lime_cairo_get_matrix_d(handle, 5));
		#else
		return cast lime.jni.Lime.lime_cairo_get_matrix(handle);
		#end
	}
	public static inline function lime_cairo_get_miter_limit(handle:CFFIPointer):Float { return lime.jni.Lime.lime_cairo_get_miter_limit(handle); }
	public static inline function lime_cairo_get_operator(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_get_operator(handle); }
	public static inline function lime_cairo_get_source(handle:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_cairo_get_source(handle); }
	public static inline function lime_cairo_get_target(handle:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_cairo_get_target(handle); }
	public static inline function lime_cairo_get_tolerance(handle:CFFIPointer):Float { return lime.jni.Lime.lime_cairo_get_tolerance(handle); }
	public static inline function lime_cairo_has_current_point(handle:CFFIPointer):Bool { return lime.jni.Lime.lime_cairo_has_current_point(handle); }
	public static inline function lime_cairo_identity_matrix(handle:CFFIPointer):Void { lime.jni.Lime.lime_cairo_identity_matrix(handle); }
	public static inline function lime_cairo_image_surface_create(format:Int, width:Int, height:Int):CFFIPointer { return cast lime.jni.Lime.lime_cairo_image_surface_create(format, width, height); }
	public static inline function lime_cairo_image_surface_create_for_data(data:DataPointer, format:Int, width:Int, height:Int, stride:Int):CFFIPointer { return cast lime.jni.Lime.lime_cairo_image_surface_create_for_data(data, format, width, height, stride); }
	public static inline function lime_cairo_image_surface_get_data(handle:CFFIPointer):DataPointer { return cast lime.jni.Lime.lime_cairo_image_surface_get_data(handle); }
	public static inline function lime_cairo_image_surface_get_format(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_image_surface_get_format(handle); }
	public static inline function lime_cairo_image_surface_get_height(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_image_surface_get_height(handle); }
	public static inline function lime_cairo_image_surface_get_stride(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_image_surface_get_stride(handle); }
	public static inline function lime_cairo_image_surface_get_width(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_image_surface_get_width(handle); }
	public static inline function lime_cairo_in_clip(handle:CFFIPointer, x:Float, y:Float):Bool { return lime.jni.Lime.lime_cairo_in_clip(handle, x, y); }
	public static inline function lime_cairo_in_fill(handle:CFFIPointer, x:Float, y:Float):Bool { return lime.jni.Lime.lime_cairo_in_fill(handle, x, y); }
	public static inline function lime_cairo_in_stroke(handle:CFFIPointer, x:Float, y:Float):Bool { return lime.jni.Lime.lime_cairo_in_stroke(handle, x, y); }
	public static inline function lime_cairo_line_to(handle:CFFIPointer, x:Float, y:Float):Void { lime.jni.Lime.lime_cairo_line_to(handle, x, y); }
	public static inline function lime_cairo_mask(handle:CFFIPointer, pattern:CFFIPointer):Void { lime.jni.Lime.lime_cairo_mask(handle, pattern); }
	public static inline function lime_cairo_mask_surface(handle:CFFIPointer, surface:CFFIPointer, x:Float, y:Float):Void { lime.jni.Lime.lime_cairo_mask_surface(handle, surface, x, y); }
	public static inline function lime_cairo_move_to(handle:CFFIPointer, x:Float, y:Float):Void { lime.jni.Lime.lime_cairo_move_to(handle, x, y); }
	public static inline function lime_cairo_new_path(handle:CFFIPointer):Void { lime.jni.Lime.lime_cairo_new_path(handle); }
	public static inline function lime_cairo_paint(handle:CFFIPointer):Void { lime.jni.Lime.lime_cairo_paint(handle); }
	public static inline function lime_cairo_paint_with_alpha(handle:CFFIPointer, alpha:Float):Void { lime.jni.Lime.lime_cairo_paint_with_alpha(handle, alpha); }
	public static inline function lime_cairo_pattern_add_color_stop_rgb(handle:CFFIPointer, offset:Float, red:Float, green:Float, blue:Float):Void { lime.jni.Lime.lime_cairo_pattern_add_color_stop_rgb(handle, offset, red, green, blue); }
	public static inline function lime_cairo_pattern_add_color_stop_rgba(handle:CFFIPointer, offset:Float, red:Float, green:Float, blue:Float, alpha:Float):Void { lime.jni.Lime.lime_cairo_pattern_add_color_stop_rgba(handle, offset, red, green, blue, alpha); }
	public static inline function lime_cairo_pattern_create_for_surface(surface:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_cairo_pattern_create_for_surface(surface); }
	public static inline function lime_cairo_pattern_create_linear(x0:Float, y0:Float, x1:Float, y1:Float):CFFIPointer { return cast lime.jni.Lime.lime_cairo_pattern_create_linear(x0, y0, x1, y1); }
	public static inline function lime_cairo_pattern_create_radial(cx0:Float, cy0:Float, radius0:Float, cx1:Float, cy1:Float, radius1:Float):CFFIPointer { return cast lime.jni.Lime.lime_cairo_pattern_create_radial(cx0, cy0, radius0, cx1, cy1, radius1); }
	public static inline function lime_cairo_pattern_create_rgb(r:Float, g:Float, b:Float):CFFIPointer { return cast lime.jni.Lime.lime_cairo_pattern_create_rgb(r, g, b); }
	public static inline function lime_cairo_pattern_create_rgba(r:Float, g:Float, b:Float, a:Float):CFFIPointer { return cast lime.jni.Lime.lime_cairo_pattern_create_rgba(r, g, b, a); }
	public static inline function lime_cairo_pattern_get_color_stop_count(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_pattern_get_color_stop_count(handle); }
	public static inline function lime_cairo_pattern_get_extend(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_pattern_get_extend(handle); }
	public static inline function lime_cairo_pattern_get_filter(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_pattern_get_filter(handle); }
	public static inline function lime_cairo_pattern_get_matrix(handle:CFFIPointer):Dynamic
	{
		#if wasmjs
		// real Matrix3, NOT an anon object — see lime_cairo_get_matrix
		return new lime.math.Matrix3(
			lime.jni.Lime.lime_cairo_pattern_get_matrix_d(handle, 0), lime.jni.Lime.lime_cairo_pattern_get_matrix_d(handle, 1),
			lime.jni.Lime.lime_cairo_pattern_get_matrix_d(handle, 2), lime.jni.Lime.lime_cairo_pattern_get_matrix_d(handle, 3),
			lime.jni.Lime.lime_cairo_pattern_get_matrix_d(handle, 4), lime.jni.Lime.lime_cairo_pattern_get_matrix_d(handle, 5));
		#else
		return cast lime.jni.Lime.lime_cairo_pattern_get_matrix(handle);
		#end
	}
	public static inline function lime_cairo_pattern_set_extend(handle:CFFIPointer, extend:Int):Void { lime.jni.Lime.lime_cairo_pattern_set_extend(handle, extend); }
	public static inline function lime_cairo_pattern_set_filter(handle:CFFIPointer, filter:Int):Void { lime.jni.Lime.lime_cairo_pattern_set_filter(handle, filter); }
	public static inline function lime_cairo_pattern_set_matrix(handle:CFFIPointer, matrix:Dynamic):Void
	{
		#if wasmjs
		// CairoPattern.set_matrix passes value.toCairoMatrix3() — plain-field class, see lime_cairo_transform
		var m:lime.math.Matrix3.CairoMatrix3 = cast matrix;
		lime.jni.Lime.lime_cairo_pattern_set_matrix_flat(handle, m.a, m.b, m.c, m.d, m.tx, m.ty);
		#else
		lime.jni.Lime.lime_cairo_pattern_set_matrix(handle, matrix);
		#end
	}
	public static inline function lime_cairo_pop_group(handle:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_cairo_pop_group(handle); }
	public static inline function lime_cairo_pop_group_to_source(handle:CFFIPointer):Void { lime.jni.Lime.lime_cairo_pop_group_to_source(handle); }
	public static inline function lime_cairo_push_group(handle:CFFIPointer):Void { lime.jni.Lime.lime_cairo_push_group(handle); }
	public static inline function lime_cairo_push_group_with_content(handle:CFFIPointer, content:Int):Void { lime.jni.Lime.lime_cairo_push_group_with_content(handle, content); }
	public static inline function lime_cairo_rectangle(handle:CFFIPointer, x:Float, y:Float, width:Float, height:Float):Void { lime.jni.Lime.lime_cairo_rectangle(handle, x, y, width, height); }
	public static inline function lime_cairo_rel_curve_to(handle:CFFIPointer, dx1:Float, dy1:Float, dx2:Float, dy2:Float, dx3:Float, dy3:Float):Void { lime.jni.Lime.lime_cairo_rel_curve_to(handle, dx1, dy1, dx2, dy2, dx3, dy3); }
	public static inline function lime_cairo_rel_line_to(handle:CFFIPointer, dx:Float, dy:Float):Void { lime.jni.Lime.lime_cairo_rel_line_to(handle, dx, dy); }
	public static inline function lime_cairo_rel_move_to(handle:CFFIPointer, dx:Float, dy:Float):Void { lime.jni.Lime.lime_cairo_rel_move_to(handle, dx, dy); }
	public static inline function lime_cairo_reset_clip(handle:CFFIPointer):Void { lime.jni.Lime.lime_cairo_reset_clip(handle); }
	public static inline function lime_cairo_restore(handle:CFFIPointer):Void { lime.jni.Lime.lime_cairo_restore(handle); }
	public static inline function lime_cairo_rotate(handle:CFFIPointer, amount:Float):Void { lime.jni.Lime.lime_cairo_rotate(handle, amount); }
	public static inline function lime_cairo_save(handle:CFFIPointer):Void { lime.jni.Lime.lime_cairo_save(handle); }
	public static inline function lime_cairo_scale(handle:CFFIPointer, x:Float, y:Float):Void { lime.jni.Lime.lime_cairo_scale(handle, x, y); }
	public static inline function lime_cairo_set_antialias(handle:CFFIPointer, cap:Int):Void { lime.jni.Lime.lime_cairo_set_antialias(handle, cap); }
	public static inline function lime_cairo_set_dash(handle:CFFIPointer, dash:Dynamic):Void { lime.jni.Lime.lime_cairo_set_dash(handle, dash); }
	public static inline function lime_cairo_set_fill_rule(handle:CFFIPointer, cap:Int):Void { lime.jni.Lime.lime_cairo_set_fill_rule(handle, cap); }
	public static inline function lime_cairo_set_font_face(handle:CFFIPointer, face:CFFIPointer):Void { lime.jni.Lime.lime_cairo_set_font_face(handle, face); }
	public static inline function lime_cairo_set_font_options(handle:CFFIPointer, options:CFFIPointer):Void { lime.jni.Lime.lime_cairo_set_font_options(handle, options); }
	public static inline function lime_cairo_set_font_size(handle:CFFIPointer, size:Float):Void { lime.jni.Lime.lime_cairo_set_font_size(handle, size); }
	public static inline function lime_cairo_set_line_cap(handle:CFFIPointer, cap:Int):Void { lime.jni.Lime.lime_cairo_set_line_cap(handle, cap); }
	public static inline function lime_cairo_set_line_join(handle:CFFIPointer, join:Int):Void { lime.jni.Lime.lime_cairo_set_line_join(handle, join); }
	public static inline function lime_cairo_set_line_width(handle:CFFIPointer, width:Float):Void { lime.jni.Lime.lime_cairo_set_line_width(handle, width); }
	public static inline function lime_cairo_set_matrix(handle:CFFIPointer, a:Float, b:Float, c:Float, d:Float, tx:Float, ty:Float):Void { lime.jni.Lime.lime_cairo_set_matrix(handle, a, b, c, d, tx, ty); }
	public static inline function lime_cairo_set_miter_limit(handle:CFFIPointer, miterLimit:Float):Void { lime.jni.Lime.lime_cairo_set_miter_limit(handle, miterLimit); }
	public static inline function lime_cairo_set_operator(handle:CFFIPointer, op:Int):Void { lime.jni.Lime.lime_cairo_set_operator(handle, op); }
	public static inline function lime_cairo_set_source(handle:CFFIPointer, pattern:CFFIPointer):Void { lime.jni.Lime.lime_cairo_set_source(handle, pattern); }
	public static inline function lime_cairo_set_source_rgb(handle:CFFIPointer, r:Float, g:Float, b:Float):Void { lime.jni.Lime.lime_cairo_set_source_rgb(handle, r, g, b); }
	public static inline function lime_cairo_set_source_rgba(handle:CFFIPointer, r:Float, g:Float, b:Float, a:Float):Void { lime.jni.Lime.lime_cairo_set_source_rgba(handle, r, g, b, a); }
	public static inline function lime_cairo_set_source_surface(handle:CFFIPointer, surface:CFFIPointer, x:Float, y:Float):Void { lime.jni.Lime.lime_cairo_set_source_surface(handle, surface, x, y); }
	public static inline function lime_cairo_set_tolerance(handle:CFFIPointer, tolerance:Float):Void { lime.jni.Lime.lime_cairo_set_tolerance(handle, tolerance); }
	public static inline function lime_cairo_show_glyphs(handle:CFFIPointer, glyphs:Dynamic):Void
	{
		#if wasmjs
		// wasm can't walk a Haxe Array<CairoGlyph>: pack (i32 index, f32 x, f32 y) per glyph.
		var arr:Array<lime.graphics.cairo.CairoGlyph> = cast glyphs;
		if (arr == null || arr.length == 0) return;
		var flat = haxe.io.Bytes.alloc(arr.length * 12);
		for (i in 0...arr.length)
		{
			flat.setInt32(i * 12, arr[i].index);
			flat.setFloat(i * 12 + 4, arr[i].x);
			flat.setFloat(i * 12 + 8, arr[i].y);
		}
		lime.jni.Lime.lime_cairo_show_glyphs_jvm(handle, flat.getData(), arr.length);
		#else
		lime.jni.Lime.lime_cairo_show_glyphs(handle, glyphs);
		#end
	}
	public static inline function lime_cairo_show_page(handle:CFFIPointer):Void { lime.jni.Lime.lime_cairo_show_page(handle); }
	public static inline function lime_cairo_show_text(handle:CFFIPointer, text:String):Void { lime.jni.Lime.lime_cairo_show_text(handle, text); }
	public static inline function lime_cairo_status(handle:CFFIPointer):Int { return lime.jni.Lime.lime_cairo_status(handle); }
	public static inline function lime_cairo_stroke(handle:CFFIPointer):Void { lime.jni.Lime.lime_cairo_stroke(handle); }
	public static inline function lime_cairo_stroke_extents(handle:CFFIPointer, x1:Float, y1:Float, x2:Float, y2:Float):Void { lime.jni.Lime.lime_cairo_stroke_extents(handle, x1, y1, x2, y2); }
	public static inline function lime_cairo_stroke_preserve(handle:CFFIPointer):Void { lime.jni.Lime.lime_cairo_stroke_preserve(handle); }
	public static inline function lime_cairo_surface_flush(surface:CFFIPointer):Void { lime.jni.Lime.lime_cairo_surface_flush(surface); }
	public static inline function lime_cairo_text_path(handle:CFFIPointer, text:String):Void { lime.jni.Lime.lime_cairo_text_path(handle, text); }
	public static inline function lime_cairo_transform(handle:CFFIPointer, matrix:Dynamic):Void
	{
		#if wasmjs
		// callers pass matrix.toCairoMatrix3() — a plain-field CairoMatrix3 CLASS, not the
		// Float32Array-backed lime.math.Matrix3 abstract; typing it wrong NPEs on genjvm
		var m:lime.math.Matrix3.CairoMatrix3 = cast matrix;
		lime.jni.Lime.lime_cairo_transform_flat(handle, m.a, m.b, m.c, m.d, m.tx, m.ty);
		#else
		lime.jni.Lime.lime_cairo_transform(handle, matrix);
		#end
	}
	public static inline function lime_cairo_translate(handle:CFFIPointer, x:Float, y:Float):Void { lime.jni.Lime.lime_cairo_translate(handle, x, y); }
	public static inline function lime_cairo_version():Int { return lime.jni.Lime.lime_cairo_version(); }
	public static inline function lime_cairo_version_string():String { return lime.jni.Lime.lime_cairo_version_string(); }
	public static inline function lime_cffi_get_native_pointer(ptr:Dynamic):Float { return lime.jni.Lime.lime_cffi_get_native_pointer(ptr); }
	public static inline function lime_clipboard_event_manager_register(callback:Dynamic, eventObject:Dynamic):Void { lime.jni.Lime.lime_clipboard_event_manager_register(callback, eventObject); }
	public static inline function lime_clipboard_get_text():Dynamic { return cast lime.jni.Lime.lime_clipboard_get_text(); }
	public static inline function lime_clipboard_set_text(text:String):Void { lime.jni.Lime.lime_clipboard_set_text(text); }
	public static inline function lime_curl_easy_cleanup(handle:CFFIPointer):Void { lime.jni.Lime.lime_curl_easy_cleanup(handle); }
	public static inline function lime_curl_easy_duphandle(handle:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_curl_easy_duphandle(handle); }
	public static inline function lime_curl_easy_escape(curl:CFFIPointer, url:String, length:Int):Dynamic { return cast lime.jni.Lime.lime_curl_easy_escape(curl, url, length); }
	public static inline function lime_curl_easy_flush(curl:CFFIPointer):Void { lime.jni.Lime.lime_curl_easy_flush(curl); }
	public static inline function lime_curl_easy_getinfo(curl:CFFIPointer, info:Int):Dynamic { return cast lime.jni.Lime.lime_curl_easy_getinfo(curl, info); }
	public static inline function lime_curl_easy_init():CFFIPointer { return cast lime.jni.Lime.lime_curl_easy_init(); }
	public static inline function lime_curl_easy_pause(handle:CFFIPointer, bitmask:Int):Int { return lime.jni.Lime.lime_curl_easy_pause(handle, bitmask); }
	public static inline function lime_curl_easy_perform(easy_handle:CFFIPointer):Int { return lime.jni.Lime.lime_curl_easy_perform(easy_handle); }
	public static inline function lime_curl_easy_recv(curl:CFFIPointer, buffer:Dynamic, buflen:Int, n:Int):Int { return lime.jni.Lime.lime_curl_easy_recv(curl, buffer, buflen, n); }
	public static inline function lime_curl_easy_reset(curl:CFFIPointer):Void { lime.jni.Lime.lime_curl_easy_reset(curl); }
	public static inline function lime_curl_easy_send(curl:CFFIPointer, buffer:Dynamic, buflen:Int, n:Int):Int { return lime.jni.Lime.lime_curl_easy_send(curl, buffer, buflen, n); }
	public static inline function lime_curl_easy_setopt(handle:CFFIPointer, option:Int, parameter:Dynamic, writeBytes:Dynamic):Int { return lime.jni.Lime.lime_curl_easy_setopt(handle, option, parameter, writeBytes); }
	public static inline function lime_curl_easy_strerror(errornum:Int):Dynamic { return cast lime.jni.Lime.lime_curl_easy_strerror(errornum); }
	public static inline function lime_curl_easy_unescape(curl:CFFIPointer, url:String, inlength:Int, outlength:Int):Dynamic { return cast lime.jni.Lime.lime_curl_easy_unescape(curl, url, inlength, outlength); }
	public static inline function lime_curl_getdate(date:String, now:Float):Float { return lime.jni.Lime.lime_curl_getdate(date, now); }
	public static inline function lime_curl_global_cleanup():Void { lime.jni.Lime.lime_curl_global_cleanup(); }
	public static inline function lime_curl_global_init(flags:Int):Int { return lime.jni.Lime.lime_curl_global_init(flags); }
	public static inline function lime_curl_multi_add_handle(multi_handle:CFFIPointer, curl_object:Dynamic, curl_handle:CFFIPointer):Int { return lime.jni.Lime.lime_curl_multi_add_handle(multi_handle, curl_object, curl_handle); }
	public static inline function lime_curl_multi_get_running_handles(multi_handle:CFFIPointer):Int { return lime.jni.Lime.lime_curl_multi_get_running_handles(multi_handle); }
	public static inline function lime_curl_multi_info_read(multi_handle:CFFIPointer):Dynamic { return cast lime.jni.Lime.lime_curl_multi_info_read(multi_handle); }
	public static inline function lime_curl_multi_init():CFFIPointer { return cast lime.jni.Lime.lime_curl_multi_init(); }
	public static inline function lime_curl_multi_perform(multi_handle:CFFIPointer):Int { return lime.jni.Lime.lime_curl_multi_perform(multi_handle); }
	public static inline function lime_curl_multi_remove_handle(multi_handle:CFFIPointer, curl_handle:CFFIPointer):Int { return lime.jni.Lime.lime_curl_multi_remove_handle(multi_handle, curl_handle); }
	public static inline function lime_curl_multi_setopt(multi_handle:CFFIPointer, option:Int, parameter:Dynamic):Int { return lime.jni.Lime.lime_curl_multi_setopt(multi_handle, option, parameter); }
	public static inline function lime_curl_multi_wait(multi_handle:CFFIPointer, timeout_ms:Int):Int { return lime.jni.Lime.lime_curl_multi_wait(multi_handle, timeout_ms); }
	public static inline function lime_curl_version():Dynamic { return cast lime.jni.Lime.lime_curl_version(); }
	public static inline function lime_curl_version_info(type:Int):Dynamic { return cast lime.jni.Lime.lime_curl_version_info(type); }
	public static inline function lime_data_pointer_offset(dataPointer:DataPointer, offset:Int):Float { return lime.jni.Lime.lime_data_pointer_offset(dataPointer, offset); }
	public static inline function lime_deflate_compress(data:Dynamic, bytes:Dynamic):Dynamic { return cast lime.jni.Lime.lime_deflate_compress(data, bytes); }
	public static inline function lime_deflate_decompress(data:Dynamic, bytes:Dynamic):Dynamic { return cast lime.jni.Lime.lime_deflate_decompress(data, bytes); }
	public static inline function lime_drop_event_manager_register(callback:Dynamic, eventObject:Dynamic):Void { lime.jni.Lime.lime_drop_event_manager_register(callback, eventObject); }
	public static inline function lime_file_dialog_open_directory(title:String, filter:String, defaultPath:String):Dynamic { return cast lime.jni.Lime.lime_file_dialog_open_directory(title, filter, defaultPath); }
	public static inline function lime_file_dialog_open_file(title:String, filter:String, defaultPath:String):Dynamic { return cast lime.jni.Lime.lime_file_dialog_open_file(title, filter, defaultPath); }
	public static inline function lime_file_dialog_open_files(title:String, filter:String, defaultPath:String):Dynamic { return cast lime.jni.Lime.lime_file_dialog_open_files(title, filter, defaultPath); }
	public static inline function lime_file_dialog_save_file(title:String, filter:String, defaultPath:String):Dynamic { return cast lime.jni.Lime.lime_file_dialog_save_file(title, filter, defaultPath); }
	public static inline function lime_file_watcher_add_directory(handle:CFFIPointer, path:Dynamic, recursive:Bool):Dynamic { return cast lime.jni.Lime.lime_file_watcher_add_directory(handle, path, recursive); }
	public static inline function lime_file_watcher_create(callback:Dynamic):CFFIPointer { return cast lime.jni.Lime.lime_file_watcher_create(callback); }
	public static inline function lime_file_watcher_remove_directory(handle:CFFIPointer, watchID:Dynamic):Void { lime.jni.Lime.lime_file_watcher_remove_directory(handle, watchID); }
	public static inline function lime_file_watcher_update(handle:CFFIPointer):Void { lime.jni.Lime.lime_file_watcher_update(handle); }
	public static inline function lime_font_get_ascender(handle:Dynamic):Int { return lime.jni.Lime.lime_font_get_ascender(handle); }
	public static inline function lime_font_get_descender(handle:Dynamic):Int { return lime.jni.Lime.lime_font_get_descender(handle); }
	public static inline function lime_font_get_family_name(handle:Dynamic):Dynamic { return cast lime.jni.Lime.lime_font_get_family_name(handle); }
	public static inline function lime_font_get_glyph_index(handle:Dynamic, character:String):Int { return lime.jni.Lime.lime_font_get_glyph_index(handle, character); }
	public static inline function lime_font_get_glyph_indices(handle:Dynamic, characters:String):Dynamic { return cast lime.jni.Lime.lime_font_get_glyph_indices(handle, characters); }
	public static inline function lime_font_get_glyph_metrics(handle:Dynamic, index:Int):Dynamic { return cast lime.jni.Lime.lime_font_get_glyph_metrics(handle, index); }
	public static inline function lime_font_get_height(handle:Dynamic):Int { return lime.jni.Lime.lime_font_get_height(handle); }
	public static inline function lime_font_get_num_glyphs(handle:Dynamic):Int { return lime.jni.Lime.lime_font_get_num_glyphs(handle); }
	public static inline function lime_font_get_strikethrough_position(handle:Dynamic):Int { return lime.jni.Lime.lime_font_get_strikethrough_position(handle); }
	public static inline function lime_font_get_strikethrough_thickness(handle:Dynamic):Int { return lime.jni.Lime.lime_font_get_strikethrough_thickness(handle); }
	public static inline function lime_font_get_underline_position(handle:Dynamic):Int { return lime.jni.Lime.lime_font_get_underline_position(handle); }
	public static inline function lime_font_get_underline_thickness(handle:Dynamic):Int { return lime.jni.Lime.lime_font_get_underline_thickness(handle); }
	public static inline function lime_font_get_units_per_em(handle:Dynamic):Int { return lime.jni.Lime.lime_font_get_units_per_em(handle); }
	public static inline function lime_font_load(data:Dynamic):Dynamic { return cast lime.jni.Lime.lime_font_load(data); }
	public static inline function lime_font_load_bytes(data:Dynamic):Dynamic
	{
		#if wasmjs
		// font bytes can't cross as a Haxe object — hand the raw byte[] to the flat bridge
		// (em side copies it; FT_New_Memory_Face keeps reading the copy).
		var bytes:haxe.io.Bytes = cast data;
		if (bytes == null || bytes.length == 0) return null;
		return cast lime.jni.Lime.lime_font_load_bytes_jvm(bytes.getData(), bytes.length);
		#else
		return cast lime.jni.Lime.lime_font_load_bytes(data);
		#end
	}
	public static inline function lime_font_load_file(path:Dynamic):Dynamic { return cast lime.jni.Lime.lime_font_load_file(path); }
	public static inline function lime_font_outline_decompose(handle:Dynamic, size:Int):Dynamic { return cast lime.jni.Lime.lime_font_outline_decompose(handle, size); }
	public static inline function lime_font_outline_decompose_no_hint(handle:Dynamic, size:Int):Dynamic { return cast lime.jni.Lime.lime_font_outline_decompose_no_hint(handle, size); }
	public static inline function lime_font_render_glyph(handle:Dynamic, index:Int, data:Dynamic):Dynamic { return cast lime.jni.Lime.lime_font_render_glyph(handle, index, data); }
	public static inline function lime_font_render_glyph_with_flags(handle:Dynamic, index:Int, loadFlags:Int, data:Dynamic):Dynamic { return cast lime.jni.Lime.lime_font_render_glyph_with_flags(handle, index, loadFlags, data); }
	public static inline function lime_font_render_glyphs(handle:Dynamic, indices:Dynamic, data:Dynamic):Dynamic { return cast lime.jni.Lime.lime_font_render_glyphs(handle, indices, data); }
	public static inline function lime_font_set_size(handle:Dynamic, size:Int, dpi:Int):Void { lime.jni.Lime.lime_font_set_size(handle, size, dpi); }
	public static inline function lime_gamepad_add_mappings(mappings:Dynamic):Void { lime.jni.Lime.lime_gamepad_add_mappings(mappings); }
	public static inline function lime_gamepad_event_manager_register(callback:Dynamic, eventObject:Dynamic):Void { lime.jni.Lime.lime_gamepad_event_manager_register(callback, eventObject); }
	public static inline function lime_gamepad_get_device_guid(id:Int):Dynamic { return cast lime.jni.Lime.lime_gamepad_get_device_guid(id); }
	public static inline function lime_gamepad_get_device_name(id:Int):Dynamic { return cast lime.jni.Lime.lime_gamepad_get_device_name(id); }
	public static inline function lime_gamepad_rumble(id:Int, lowFrequencyRumble:Float, highFrequencyRumble:Float, duration:Int):Void { lime.jni.Lime.lime_gamepad_rumble(id, lowFrequencyRumble, highFrequencyRumble, duration); }
	public static inline function lime_gl_active_texture(texture:Int):Void { lime.jni.Lime.lime_gl_active_texture(texture); }
	public static inline function lime_gl_attach_shader(program:Int, shader:Int):Void { lime.jni.Lime.lime_gl_attach_shader(program, shader); }
	public static inline function lime_gl_begin_query(target:Int, query:Int):Void { lime.jni.Lime.lime_gl_begin_query(target, query); }
	public static inline function lime_gl_begin_transform_feedback(primitiveNode:Int):Void { lime.jni.Lime.lime_gl_begin_transform_feedback(primitiveNode); }
	public static inline function lime_gl_bind_attrib_location(program:Int, index:Int, name:String):Void { lime.jni.Lime.lime_gl_bind_attrib_location(program, index, name); }
	public static inline function lime_gl_bind_buffer(target:Int, buffer:Int):Void { lime.jni.Lime.lime_gl_bind_buffer(target, buffer); }
	public static inline function lime_gl_bind_buffer_base(target:Int, index:Int, buffer:Int):Void { lime.jni.Lime.lime_gl_bind_buffer_base(target, index, buffer); }
	public static inline function lime_gl_bind_buffer_range(target:Int, index:Int, buffer:Int, offset:DataPointer, size:Int):Void { lime.jni.Lime.lime_gl_bind_buffer_range(target, index, buffer, offset, size); }
	public static inline function lime_gl_bind_framebuffer(target:Int, framebuffer:Int):Void { lime.jni.Lime.lime_gl_bind_framebuffer(target, framebuffer); }
	public static inline function lime_gl_bind_renderbuffer(target:Int, renderbuffer:Int):Void { lime.jni.Lime.lime_gl_bind_renderbuffer(target, renderbuffer); }
	public static inline function lime_gl_bind_sampler(target:Int, sampler:Int):Void { lime.jni.Lime.lime_gl_bind_sampler(target, sampler); }
	public static inline function lime_gl_bind_texture(target:Int, texture:Int):Void { lime.jni.Lime.lime_gl_bind_texture(target, texture); }
	public static inline function lime_gl_bind_transform_feedback(target:Int, transformFeedback:Int):Void { lime.jni.Lime.lime_gl_bind_transform_feedback(target, transformFeedback); }
	public static inline function lime_gl_bind_vertex_array(vertexArray:Int):Void { lime.jni.Lime.lime_gl_bind_vertex_array(vertexArray); }
	public static inline function lime_gl_blend_color(red:Float32, green:Float32, blue:Float32, alpha:Float32):Void { lime.jni.Lime.lime_gl_blend_color(red, green, blue, alpha); }
	public static inline function lime_gl_blend_equation(mode:Int):Void { lime.jni.Lime.lime_gl_blend_equation(mode); }
	public static inline function lime_gl_blend_equation_separate(modeRGB:Int, modeAlpha:Int):Void { lime.jni.Lime.lime_gl_blend_equation_separate(modeRGB, modeAlpha); }
	public static inline function lime_gl_blend_func(sfactor:Int, dfactor:Int):Void { lime.jni.Lime.lime_gl_blend_func(sfactor, dfactor); }
	public static inline function lime_gl_blend_func_separate(srcRGB:Int, dstRGB:Int, srcAlpha:Int, dstAlpha:Int):Void { lime.jni.Lime.lime_gl_blend_func_separate(srcRGB, dstRGB, srcAlpha, dstAlpha); }
	public static inline function lime_gl_blit_framebuffer(srcX0:Int, srcY0:Int, srcX1:Int, srcY1:Int, dstX0:Int, dstY0:Int, dstX1:Int, dstY1:Int, mask:Int, filter:Int):Void { lime.jni.Lime.lime_gl_blit_framebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter); }
	public static inline function lime_gl_buffer_data(target:Int, size:Int, srcData:DataPointer, usage:Int):Void { lime.jni.Lime.lime_gl_buffer_data(target, size, srcData, usage); }
	public static inline function lime_gl_buffer_sub_data(target:Int, offset:Int, size:Int, srcData:DataPointer):Void { lime.jni.Lime.lime_gl_buffer_sub_data(target, offset, size, srcData); }
	public static inline function lime_gl_check_framebuffer_status(target:Int):Int { return lime.jni.Lime.lime_gl_check_framebuffer_status(target); }
	public static inline function lime_gl_clear(mask:Int):Void { lime.jni.Lime.lime_gl_clear(mask); }
	public static inline function lime_gl_clear_bufferfi(buffer:Int, drawBuffer:Int, depth:Float32, stencil:Int):Void { lime.jni.Lime.lime_gl_clear_bufferfi(buffer, drawBuffer, depth, stencil); }
	public static inline function lime_gl_clear_bufferfv(buffer:Int, drawBuffer:Int, data:DataPointer):Void { lime.jni.Lime.lime_gl_clear_bufferfv(buffer, drawBuffer, data); }
	public static inline function lime_gl_clear_bufferiv(buffer:Int, drawBuffer:Int, data:DataPointer):Void { lime.jni.Lime.lime_gl_clear_bufferiv(buffer, drawBuffer, data); }
	public static inline function lime_gl_clear_bufferuiv(buffer:Int, drawBuffer:Int, data:DataPointer):Void { lime.jni.Lime.lime_gl_clear_bufferuiv(buffer, drawBuffer, data); }
	public static inline function lime_gl_clear_color(red:Float32, green:Float32, blue:Float32, alpha:Float32):Void { lime.jni.Lime.lime_gl_clear_color(red, green, blue, alpha); }
	public static inline function lime_gl_clear_depthf(depth:Float32):Void { lime.jni.Lime.lime_gl_clear_depthf(depth); }
	public static inline function lime_gl_clear_stencil(s:Int):Void { lime.jni.Lime.lime_gl_clear_stencil(s); }
	public static inline function lime_gl_client_wait_sync(sync:CFFIPointer, flags:Int, timeoutA:Int, timeoutB:Int):Int { return lime.jni.Lime.lime_gl_client_wait_sync(sync, flags, timeoutA, timeoutB); }
	public static inline function lime_gl_color_mask(red:Bool, green:Bool, blue:Bool, alpha:Bool):Void { lime.jni.Lime.lime_gl_color_mask(red, green, blue, alpha); }
	public static inline function lime_gl_compile_shader(shader:Int):Void { lime.jni.Lime.lime_gl_compile_shader(shader); }
	public static inline function lime_gl_compressed_tex_image_2d(target:Int, level:Int, internalformat:Int, width:Int, height:Int, border:Int, imageSize:Int, data:DataPointer):Void { lime.jni.Lime.lime_gl_compressed_tex_image_2d(target, level, internalformat, width, height, border, imageSize, data); }
	public static inline function lime_gl_compressed_tex_image_3d(target:Int, level:Int, internalformat:Int, width:Int, height:Int, depth:Int, border:Int, imageSize:Int, data:DataPointer):Void { lime.jni.Lime.lime_gl_compressed_tex_image_3d(target, level, internalformat, width, height, depth, border, imageSize, data); }
	public static inline function lime_gl_compressed_tex_sub_image_2d(target:Int, level:Int, xoffset:Int, yoffset:Int, width:Int, height:Int, format:Int, imageSize:Int, data:DataPointer):Void { lime.jni.Lime.lime_gl_compressed_tex_sub_image_2d(target, level, xoffset, yoffset, width, height, format, imageSize, data); }
	public static inline function lime_gl_compressed_tex_sub_image_3d(target:Int, level:Int, xoffset:Int, yoffset:Int, zoffset:Int, width:Int, height:Int, depth:Int, format:Int, imageSize:Int, data:DataPointer):Void { lime.jni.Lime.lime_gl_compressed_tex_sub_image_3d(target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data); }
	public static inline function lime_gl_copy_buffer_sub_data(readTarget:Int, writeTarget:Int, readOffset:DataPointer, writeOffset:DataPointer, size:Int):Void { lime.jni.Lime.lime_gl_copy_buffer_sub_data(readTarget, writeTarget, readOffset, writeOffset, size); }
	public static inline function lime_gl_copy_tex_image_2d(target:Int, level:Int, internalformat:Int, x:Int, y:Int, width:Int, height:Int, border:Int):Void { lime.jni.Lime.lime_gl_copy_tex_image_2d(target, level, internalformat, x, y, width, height, border); }
	public static inline function lime_gl_copy_tex_sub_image_2d(target:Int, level:Int, xoffset:Int, yoffset:Int, x:Int, y:Int, width:Int, height:Int):Void { lime.jni.Lime.lime_gl_copy_tex_sub_image_2d(target, level, xoffset, yoffset, x, y, width, height); }
	public static inline function lime_gl_copy_tex_sub_image_3d(target:Int, level:Int, xoffset:Int, yoffset:Int, zoffset:Int, x:Int, y:Int, width:Int, height:Int):Void { lime.jni.Lime.lime_gl_copy_tex_sub_image_3d(target, level, xoffset, yoffset, zoffset, x, y, width, height); }
	public static inline function lime_gl_create_buffer():Int { return lime.jni.Lime.lime_gl_create_buffer(); }
	public static inline function lime_gl_create_framebuffer():Int { return lime.jni.Lime.lime_gl_create_framebuffer(); }
	public static inline function lime_gl_create_program():Int { return lime.jni.Lime.lime_gl_create_program(); }
	public static inline function lime_gl_create_query():Int { return lime.jni.Lime.lime_gl_create_query(); }
	public static inline function lime_gl_create_renderbuffer():Int { return lime.jni.Lime.lime_gl_create_renderbuffer(); }
	public static inline function lime_gl_create_sampler():Int { return lime.jni.Lime.lime_gl_create_sampler(); }
	public static inline function lime_gl_create_shader(type:Int):Int { return lime.jni.Lime.lime_gl_create_shader(type); }
	public static inline function lime_gl_create_texture():Int { return lime.jni.Lime.lime_gl_create_texture(); }
	public static inline function lime_gl_create_transform_feedback():Int { return lime.jni.Lime.lime_gl_create_transform_feedback(); }
	public static inline function lime_gl_create_vertex_array():Int { return lime.jni.Lime.lime_gl_create_vertex_array(); }
	public static inline function lime_gl_cull_face(mode:Int):Void { lime.jni.Lime.lime_gl_cull_face(mode); }
	public static inline function lime_gl_delete_buffer(buffer:Int):Void { lime.jni.Lime.lime_gl_delete_buffer(buffer); }
	public static inline function lime_gl_delete_framebuffer(framebuffer:Int):Void { lime.jni.Lime.lime_gl_delete_framebuffer(framebuffer); }
	public static inline function lime_gl_delete_program(program:Int):Void { lime.jni.Lime.lime_gl_delete_program(program); }
	public static inline function lime_gl_delete_query(query:Int):Void { lime.jni.Lime.lime_gl_delete_query(query); }
	public static inline function lime_gl_delete_renderbuffer(renderbuffer:Int):Void { lime.jni.Lime.lime_gl_delete_renderbuffer(renderbuffer); }
	public static inline function lime_gl_delete_sampler(sampler:Int):Void { lime.jni.Lime.lime_gl_delete_sampler(sampler); }
	public static inline function lime_gl_delete_shader(shader:Int):Void { lime.jni.Lime.lime_gl_delete_shader(shader); }
	public static inline function lime_gl_delete_sync(sync:CFFIPointer):Void { lime.jni.Lime.lime_gl_delete_sync(sync); }
	public static inline function lime_gl_delete_texture(texture:Int):Void { lime.jni.Lime.lime_gl_delete_texture(texture); }
	public static inline function lime_gl_delete_transform_feedback(transformFeedback:Int):Void { lime.jni.Lime.lime_gl_delete_transform_feedback(transformFeedback); }
	public static inline function lime_gl_delete_vertex_array(vertexArray:Int):Void { lime.jni.Lime.lime_gl_delete_vertex_array(vertexArray); }
	public static inline function lime_gl_depth_func(func:Int):Void { lime.jni.Lime.lime_gl_depth_func(func); }
	public static inline function lime_gl_depth_mask(flag:Bool):Void { lime.jni.Lime.lime_gl_depth_mask(flag); }
	public static inline function lime_gl_depth_rangef(zNear:Float32, zFar:Float32):Void { lime.jni.Lime.lime_gl_depth_rangef(zNear, zFar); }
	public static inline function lime_gl_detach_shader(program:Int, shader:Int):Void { lime.jni.Lime.lime_gl_detach_shader(program, shader); }
	public static inline function lime_gl_disable(cap:Int):Void { lime.jni.Lime.lime_gl_disable(cap); }
	public static inline function lime_gl_disable_vertex_attrib_array(index:Int):Void { lime.jni.Lime.lime_gl_disable_vertex_attrib_array(index); }
	public static inline function lime_gl_draw_arrays(mode:Int, first:Int, count:Int):Void { lime.jni.Lime.lime_gl_draw_arrays(mode, first, count); }
	public static inline function lime_gl_draw_arrays_instanced(mode:Int, first:Int, count:Int, instanceCount:Int):Void { lime.jni.Lime.lime_gl_draw_arrays_instanced(mode, first, count, instanceCount); }
	public static inline function lime_gl_draw_buffers(buffers:Dynamic):Void { lime.jni.Lime.lime_gl_draw_buffers(buffers); }
	public static inline function lime_gl_draw_elements(mode:Int, count:Int, type:Int, offset:DataPointer):Void { lime.jni.Lime.lime_gl_draw_elements(mode, count, type, offset); }
	public static inline function lime_gl_draw_elements_instanced(mode:Int, count:Int, type:Int, offset:DataPointer, instanceCount:Int):Void { lime.jni.Lime.lime_gl_draw_elements_instanced(mode, count, type, offset, instanceCount); }
	public static inline function lime_gl_draw_range_elements(mode:Int, start:Int, end:Int, count:Int, type:Int, offset:DataPointer):Void { lime.jni.Lime.lime_gl_draw_range_elements(mode, start, end, count, type, offset); }
	public static inline function lime_gl_enable(cap:Int):Void { lime.jni.Lime.lime_gl_enable(cap); }
	public static inline function lime_gl_enable_vertex_attrib_array(index:Int):Void { lime.jni.Lime.lime_gl_enable_vertex_attrib_array(index); }
	public static inline function lime_gl_end_query(target:Int):Void { lime.jni.Lime.lime_gl_end_query(target); }
	public static inline function lime_gl_end_transform_feedback():Void { lime.jni.Lime.lime_gl_end_transform_feedback(); }
	public static inline function lime_gl_fence_sync(condition:Int, flags:Int):CFFIPointer { return cast lime.jni.Lime.lime_gl_fence_sync(condition, flags); }
	public static inline function lime_gl_finish():Void { lime.jni.Lime.lime_gl_finish(); }
	public static inline function lime_gl_flush():Void { lime.jni.Lime.lime_gl_flush(); }
	public static inline function lime_gl_framebuffer_renderbuffer(target:Int, attachment:Int, renderbuffertarget:Int, renderbuffer:Int):Void { lime.jni.Lime.lime_gl_framebuffer_renderbuffer(target, attachment, renderbuffertarget, renderbuffer); }
	public static inline function lime_gl_framebuffer_texture2D(target:Int, attachment:Int, textarget:Int, texture:Int, level:Int):Void { lime.jni.Lime.lime_gl_framebuffer_texture2D(target, attachment, textarget, texture, level); }
	public static inline function lime_gl_framebuffer_texture_layer(target:Int, attachment:Int, texture:Int, level:Int, layer:Int):Void { lime.jni.Lime.lime_gl_framebuffer_texture_layer(target, attachment, texture, level, layer); }
	public static inline function lime_gl_front_face(mode:Int):Void { lime.jni.Lime.lime_gl_front_face(mode); }
	public static inline function lime_gl_generate_mipmap(target:Int):Void { lime.jni.Lime.lime_gl_generate_mipmap(target); }
	public static inline function lime_gl_get_active_attrib(program:Int, index:Int):Dynamic { return cast lime.jni.Lime.lime_gl_get_active_attrib(program, index); }
	public static inline function lime_gl_get_active_uniform(program:Int, index:Int):Dynamic { return cast lime.jni.Lime.lime_gl_get_active_uniform(program, index); }
	public static inline function lime_gl_get_active_uniform_block_name(program:Int, uniformBlockIndex:Int):Dynamic { return cast lime.jni.Lime.lime_gl_get_active_uniform_block_name(program, uniformBlockIndex); }
	public static inline function lime_gl_get_active_uniform_blocki(program:Int, uniformBlockIndex:Int, pname:Int):Int { return lime.jni.Lime.lime_gl_get_active_uniform_blocki(program, uniformBlockIndex, pname); }
	public static inline function lime_gl_get_active_uniform_blockiv(program:Int, uniformBlockIndex:Int, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_active_uniform_blockiv(program, uniformBlockIndex, pname, params); }
	public static inline function lime_gl_get_active_uniformsiv(program:Int, uniformIndices:Dynamic, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_active_uniformsiv(program, uniformIndices, pname, params); }
	public static inline function lime_gl_get_attached_shaders(program:Int):Dynamic { return cast lime.jni.Lime.lime_gl_get_attached_shaders(program); }
	public static inline function lime_gl_get_attrib_location(program:Int, name:String):Int { return lime.jni.Lime.lime_gl_get_attrib_location(program, name); }
	public static inline function lime_gl_get_boolean(pname:Int):Bool { return lime.jni.Lime.lime_gl_get_boolean(pname); }
	public static inline function lime_gl_get_booleanv(pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_booleanv(pname, params); }
	public static inline function lime_gl_get_buffer_parameteri(target:Int, pname:Int):Int { return lime.jni.Lime.lime_gl_get_buffer_parameteri(target, pname); }
	public static inline function lime_gl_get_buffer_parameteri64v(target:Int, index:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_buffer_parameteri64v(target, index, params); }
	public static inline function lime_gl_get_buffer_parameteriv(target:Int, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_buffer_parameteriv(target, pname, params); }
	public static inline function lime_gl_get_buffer_pointerv(target:Int, pname:Int):DataPointer { return cast lime.jni.Lime.lime_gl_get_buffer_pointerv(target, pname); }
	public static inline function lime_gl_get_buffer_sub_data(target:Int, offset:DataPointer, size:Int, data:DataPointer):Void { lime.jni.Lime.lime_gl_get_buffer_sub_data(target, offset, size, data); }
	public static inline function lime_gl_get_context_attributes():Dynamic { return cast lime.jni.Lime.lime_gl_get_context_attributes(); }
	public static inline function lime_gl_get_error():Int { return lime.jni.Lime.lime_gl_get_error(); }
	public static inline function lime_gl_get_extension(name:String):Dynamic { return cast lime.jni.Lime.lime_gl_get_extension(name); }
	public static inline function lime_gl_get_float(pname:Int):Float32 { return lime.jni.Lime.lime_gl_get_float(pname); }
	public static inline function lime_gl_get_floatv(pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_floatv(pname, params); }
	public static inline function lime_gl_get_frag_data_location(program:Int, name:String):Int { return lime.jni.Lime.lime_gl_get_frag_data_location(program, name); }
	public static inline function lime_gl_get_framebuffer_attachment_parameteri(target:Int, attachment:Int, pname:Int):Int { return lime.jni.Lime.lime_gl_get_framebuffer_attachment_parameteri(target, attachment, pname); }
	public static inline function lime_gl_get_framebuffer_attachment_parameteriv(target:Int, attachment:Int, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_framebuffer_attachment_parameteriv(target, attachment, pname, params); }
	public static inline function lime_gl_get_integer(pname:Int):Int { return lime.jni.Lime.lime_gl_get_integer(pname); }
	public static inline function lime_gl_get_integer64i_v(pname:Int, index:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_integer64i_v(pname, index, params); }
	public static inline function lime_gl_get_integer64v(pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_integer64v(pname, params); }
	public static inline function lime_gl_get_integeri_v(pname:Int, index:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_integeri_v(pname, index, params); }
	public static inline function lime_gl_get_integerv(pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_integerv(pname, params); }
	public static inline function lime_gl_get_internalformativ(target:Int, internalformat:Int, pname:Int, bufSize:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_internalformativ(target, internalformat, pname, bufSize, params); }
	public static inline function lime_gl_get_program_binary(program:Int, binaryFormat:Int, bytes:Dynamic):Void { lime.jni.Lime.lime_gl_get_program_binary(program, binaryFormat, bytes); }
	public static inline function lime_gl_get_program_info_log(program:Int):Dynamic { return cast lime.jni.Lime.lime_gl_get_program_info_log(program); }
	public static inline function lime_gl_get_programi(program:Int, pname:Int):Int { return lime.jni.Lime.lime_gl_get_programi(program, pname); }
	public static inline function lime_gl_get_programiv(program:Int, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_programiv(program, pname, params); }
	public static inline function lime_gl_get_query_objectui(target:Int, pname:Int):Int { return lime.jni.Lime.lime_gl_get_query_objectui(target, pname); }
	public static inline function lime_gl_get_query_objectuiv(target:Int, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_query_objectuiv(target, pname, params); }
	public static inline function lime_gl_get_queryi(target:Int, pname:Int):Int { return lime.jni.Lime.lime_gl_get_queryi(target, pname); }
	public static inline function lime_gl_get_queryiv(target:Int, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_queryiv(target, pname, params); }
	public static inline function lime_gl_get_renderbuffer_parameteri(target:Int, pname:Int):Int { return lime.jni.Lime.lime_gl_get_renderbuffer_parameteri(target, pname); }
	public static inline function lime_gl_get_renderbuffer_parameteriv(target:Int, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_renderbuffer_parameteriv(target, pname, params); }
	public static inline function lime_gl_get_sampler_parameterf(target:Int, pname:Int):Float32 { return lime.jni.Lime.lime_gl_get_sampler_parameterf(target, pname); }
	public static inline function lime_gl_get_sampler_parameterfv(target:Int, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_sampler_parameterfv(target, pname, params); }
	public static inline function lime_gl_get_sampler_parameteri(target:Int, pname:Int):Int { return lime.jni.Lime.lime_gl_get_sampler_parameteri(target, pname); }
	public static inline function lime_gl_get_sampler_parameteriv(target:Int, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_sampler_parameteriv(target, pname, params); }
	public static inline function lime_gl_get_shader_info_log(shader:Int):Dynamic { return cast lime.jni.Lime.lime_gl_get_shader_info_log(shader); }
	public static inline function lime_gl_get_shader_precision_format(shadertype:Int, precisiontype:Int):Dynamic { return cast lime.jni.Lime.lime_gl_get_shader_precision_format(shadertype, precisiontype); }
	public static inline function lime_gl_get_shader_source(shader:Int):Dynamic { return cast lime.jni.Lime.lime_gl_get_shader_source(shader); }
	public static inline function lime_gl_get_shaderi(shader:Int, pname:Int):Int { return lime.jni.Lime.lime_gl_get_shaderi(shader, pname); }
	public static inline function lime_gl_get_shaderiv(shader:Int, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_shaderiv(shader, pname, params); }
	public static inline function lime_gl_get_string(pname:Int):Dynamic { return cast lime.jni.Lime.lime_gl_get_string(pname); }
	public static inline function lime_gl_get_stringi(pname:Int, index:Int):Dynamic { return cast lime.jni.Lime.lime_gl_get_stringi(pname, index); }
	public static inline function lime_gl_get_sync_parameteri(sync:CFFIPointer, pname:Int):Int { return lime.jni.Lime.lime_gl_get_sync_parameteri(sync, pname); }
	public static inline function lime_gl_get_sync_parameteriv(sync:CFFIPointer, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_sync_parameteriv(sync, pname, params); }
	public static inline function lime_gl_get_tex_parameterf(target:Int, pname:Int):Float32 { return lime.jni.Lime.lime_gl_get_tex_parameterf(target, pname); }
	public static inline function lime_gl_get_tex_parameterfv(target:Int, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_tex_parameterfv(target, pname, params); }
	public static inline function lime_gl_get_tex_parameteri(target:Int, pname:Int):Int { return lime.jni.Lime.lime_gl_get_tex_parameteri(target, pname); }
	public static inline function lime_gl_get_tex_parameteriv(target:Int, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_tex_parameteriv(target, pname, params); }
	public static inline function lime_gl_get_transform_feedback_varying(program:Int, index:Int):Dynamic { return cast lime.jni.Lime.lime_gl_get_transform_feedback_varying(program, index); }
	public static inline function lime_gl_get_uniform_block_index(program:Int, uniformBlockName:String):Int { return lime.jni.Lime.lime_gl_get_uniform_block_index(program, uniformBlockName); }
	public static inline function lime_gl_get_uniform_location(program:Int, name:String):Int { return lime.jni.Lime.lime_gl_get_uniform_location(program, name); }
	public static inline function lime_gl_get_uniformf(program:Int, location:Int):Float32 { return lime.jni.Lime.lime_gl_get_uniformf(program, location); }
	public static inline function lime_gl_get_uniformfv(program:Int, location:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_uniformfv(program, location, params); }
	public static inline function lime_gl_get_uniformi(program:Int, location:Int):Int { return lime.jni.Lime.lime_gl_get_uniformi(program, location); }
	public static inline function lime_gl_get_uniformiv(program:Int, location:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_uniformiv(program, location, params); }
	public static inline function lime_gl_get_uniformui(program:Int, location:Int):Int { return lime.jni.Lime.lime_gl_get_uniformui(program, location); }
	public static inline function lime_gl_get_uniformuiv(program:Int, location:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_uniformuiv(program, location, params); }
	public static inline function lime_gl_get_vertex_attrib_pointerv(index:Int, pname:Int):DataPointer { return cast lime.jni.Lime.lime_gl_get_vertex_attrib_pointerv(index, pname); }
	public static inline function lime_gl_get_vertex_attribf(index:Int, pname:Int):Float32 { return lime.jni.Lime.lime_gl_get_vertex_attribf(index, pname); }
	public static inline function lime_gl_get_vertex_attribfv(index:Int, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_vertex_attribfv(index, pname, params); }
	public static inline function lime_gl_get_vertex_attribi(index:Int, pname:Int):Int { return lime.jni.Lime.lime_gl_get_vertex_attribi(index, pname); }
	public static inline function lime_gl_get_vertex_attribii(index:Int, pname:Int):Int { return lime.jni.Lime.lime_gl_get_vertex_attribii(index, pname); }
	public static inline function lime_gl_get_vertex_attribiiv(index:Int, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_vertex_attribiiv(index, pname, params); }
	public static inline function lime_gl_get_vertex_attribiui(index:Int, pname:Int):Int { return lime.jni.Lime.lime_gl_get_vertex_attribiui(index, pname); }
	public static inline function lime_gl_get_vertex_attribiuiv(index:Int, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_vertex_attribiuiv(index, pname, params); }
	public static inline function lime_gl_get_vertex_attribiv(index:Int, pname:Int, params:DataPointer):Void { lime.jni.Lime.lime_gl_get_vertex_attribiv(index, pname, params); }
	public static inline function lime_gl_hint(target:Int, mode:Int):Void { lime.jni.Lime.lime_gl_hint(target, mode); }
	public static inline function lime_gl_invalidate_framebuffer(target:Int, attachments:Dynamic):Void { lime.jni.Lime.lime_gl_invalidate_framebuffer(target, attachments); }
	public static inline function lime_gl_invalidate_sub_framebuffer(target:Int, attachments:Dynamic, x:Int, y:Int, width:Int, height:Int):Void { lime.jni.Lime.lime_gl_invalidate_sub_framebuffer(target, attachments, x, y, width, height); }
	public static inline function lime_gl_is_buffer(buffer:Int):Bool { return lime.jni.Lime.lime_gl_is_buffer(buffer); }
	public static inline function lime_gl_is_enabled(cap:Int):Bool { return lime.jni.Lime.lime_gl_is_enabled(cap); }
	public static inline function lime_gl_is_framebuffer(framebuffer:Int):Bool { return lime.jni.Lime.lime_gl_is_framebuffer(framebuffer); }
	public static inline function lime_gl_is_program(program:Int):Bool { return lime.jni.Lime.lime_gl_is_program(program); }
	public static inline function lime_gl_is_query(query:Int):Bool { return lime.jni.Lime.lime_gl_is_query(query); }
	public static inline function lime_gl_is_renderbuffer(renderbuffer:Int):Bool { return lime.jni.Lime.lime_gl_is_renderbuffer(renderbuffer); }
	public static inline function lime_gl_is_sampler(sampler:Int):Bool { return lime.jni.Lime.lime_gl_is_sampler(sampler); }
	public static inline function lime_gl_is_shader(shader:Int):Bool { return lime.jni.Lime.lime_gl_is_shader(shader); }
	public static inline function lime_gl_is_sync(sync:CFFIPointer):Bool { return lime.jni.Lime.lime_gl_is_sync(sync); }
	public static inline function lime_gl_is_texture(texture:Int):Bool { return lime.jni.Lime.lime_gl_is_texture(texture); }
	public static inline function lime_gl_is_transform_feedback(transformFeedback:Int):Bool { return lime.jni.Lime.lime_gl_is_transform_feedback(transformFeedback); }
	public static inline function lime_gl_is_vertex_array(vertexArray:Int):Bool { return lime.jni.Lime.lime_gl_is_vertex_array(vertexArray); }
	public static inline function lime_gl_line_width(width:Float32):Void { lime.jni.Lime.lime_gl_line_width(width); }
	public static inline function lime_gl_link_program(program:Int):Void { lime.jni.Lime.lime_gl_link_program(program); }
	public static inline function lime_gl_map_buffer_range(target:Int, offset:DataPointer, length:Int, access:Int):DataPointer { return cast lime.jni.Lime.lime_gl_map_buffer_range(target, offset, length, access); }
	public static inline function lime_gl_object_deregister(object:Dynamic):Void { lime.jni.Lime.lime_gl_object_deregister(object); }
	public static inline function lime_gl_object_from_id(id:Int, type:Int):Dynamic { return cast lime.jni.Lime.lime_gl_object_from_id(id, type); }
	public static inline function lime_gl_object_register(id:Int, type:Int, object:Dynamic):Dynamic { return cast lime.jni.Lime.lime_gl_object_register(id, type, object); }
	public static inline function lime_gl_pause_transform_feedback():Void { lime.jni.Lime.lime_gl_pause_transform_feedback(); }
	public static inline function lime_gl_pixel_storei(pname:Int, param:Int):Void { lime.jni.Lime.lime_gl_pixel_storei(pname, param); }
	public static inline function lime_gl_polygon_offset(factor:Float32, units:Float32):Void { lime.jni.Lime.lime_gl_polygon_offset(factor, units); }
	public static inline function lime_gl_program_binary(program:Int, binaryFormat:Int, binary:DataPointer, length:Int):Void { lime.jni.Lime.lime_gl_program_binary(program, binaryFormat, binary, length); }
	public static inline function lime_gl_program_parameteri(program:Int, pname:Int, value:Int):Void { lime.jni.Lime.lime_gl_program_parameteri(program, pname, value); }
	public static inline function lime_gl_read_buffer(src:Int):Void { lime.jni.Lime.lime_gl_read_buffer(src); }
	public static inline function lime_gl_read_pixels(x:Int, y:Int, width:Int, height:Int, format:Int, type:Int, pixels:DataPointer):Void { lime.jni.Lime.lime_gl_read_pixels(x, y, width, height, format, type, pixels); }
	public static inline function lime_gl_release_shader_compiler():Void { lime.jni.Lime.lime_gl_release_shader_compiler(); }
	public static inline function lime_gl_renderbuffer_storage(target:Int, internalformat:Int, width:Int, height:Int):Void { lime.jni.Lime.lime_gl_renderbuffer_storage(target, internalformat, width, height); }
	public static inline function lime_gl_renderbuffer_storage_multisample(target:Int, samples:Int, internalformat:Int, width:Int, height:Int):Void { lime.jni.Lime.lime_gl_renderbuffer_storage_multisample(target, samples, internalformat, width, height); }
	public static inline function lime_gl_resume_transform_feedback():Void { lime.jni.Lime.lime_gl_resume_transform_feedback(); }
	public static inline function lime_gl_sample_coverage(value:Float32, invert:Bool):Void { lime.jni.Lime.lime_gl_sample_coverage(value, invert); }
	public static inline function lime_gl_sampler_parameterf(sampler:Int, pname:Int, param:Float32):Void { lime.jni.Lime.lime_gl_sampler_parameterf(sampler, pname, param); }
	public static inline function lime_gl_sampler_parameteri(sampler:Int, pname:Int, param:Int):Void { lime.jni.Lime.lime_gl_sampler_parameteri(sampler, pname, param); }
	public static inline function lime_gl_scissor(x:Int, y:Int, width:Int, height:Int):Void { lime.jni.Lime.lime_gl_scissor(x, y, width, height); }
	public static inline function lime_gl_shader_binary(shaders:Dynamic, binaryformat:Int, binary:DataPointer, length:Int):Void { lime.jni.Lime.lime_gl_shader_binary(shaders, binaryformat, binary, length); }
	public static inline function lime_gl_shader_source(shader:Int, source:String):Void { lime.jni.Lime.lime_gl_shader_source(shader, source); }
	public static inline function lime_gl_stencil_func(func:Int, ref:Int, mask:Int):Void { lime.jni.Lime.lime_gl_stencil_func(func, ref, mask); }
	public static inline function lime_gl_stencil_func_separate(face:Int, func:Int, ref:Int, mask:Int):Void { lime.jni.Lime.lime_gl_stencil_func_separate(face, func, ref, mask); }
	public static inline function lime_gl_stencil_mask(mask:Int):Void { lime.jni.Lime.lime_gl_stencil_mask(mask); }
	public static inline function lime_gl_stencil_mask_separate(face:Int, mask:Int):Void { lime.jni.Lime.lime_gl_stencil_mask_separate(face, mask); }
	public static inline function lime_gl_stencil_op(fail:Int, zfail:Int, zpass:Int):Void { lime.jni.Lime.lime_gl_stencil_op(fail, zfail, zpass); }
	public static inline function lime_gl_stencil_op_separate(face:Int, fail:Int, zfail:Int, zpass:Int):Void { lime.jni.Lime.lime_gl_stencil_op_separate(face, fail, zfail, zpass); }
	public static inline function lime_gl_tex_image_2d(target:Int, level:Int, internalformat:Int, width:Int, height:Int, border:Int, format:Int, type:Int, data:DataPointer):Void { lime.jni.Lime.lime_gl_tex_image_2d(target, level, internalformat, width, height, border, format, type, data); }
	public static inline function lime_gl_tex_image_3d(target:Int, level:Int, internalformat:Int, width:Int, height:Int, depth:Int, border:Int, format:Int, type:Int, data:DataPointer):Void { lime.jni.Lime.lime_gl_tex_image_3d(target, level, internalformat, width, height, depth, border, format, type, data); }
	public static inline function lime_gl_tex_parameterf(target:Int, pname:Int, param:Float32):Void { lime.jni.Lime.lime_gl_tex_parameterf(target, pname, param); }
	public static inline function lime_gl_tex_parameteri(target:Int, pname:Int, param:Int):Void { lime.jni.Lime.lime_gl_tex_parameteri(target, pname, param); }
	public static inline function lime_gl_tex_storage_2d(target:Int, level:Int, internalformat:Int, width:Int, height:Int):Void { lime.jni.Lime.lime_gl_tex_storage_2d(target, level, internalformat, width, height); }
	public static inline function lime_gl_tex_storage_3d(target:Int, level:Int, internalformat:Int, width:Int, height:Int, depth:Int):Void { lime.jni.Lime.lime_gl_tex_storage_3d(target, level, internalformat, width, height, depth); }
	public static inline function lime_gl_tex_sub_image_2d(target:Int, level:Int, xoffset:Int, yoffset:Int, width:Int, height:Int, format:Int, type:Int, data:DataPointer):Void { lime.jni.Lime.lime_gl_tex_sub_image_2d(target, level, xoffset, yoffset, width, height, format, type, data); }
	public static inline function lime_gl_tex_sub_image_3d(target:Int, level:Int, xoffset:Int, yoffset:Int, zoffset:Int, width:Int, height:Int, depth:Int, format:Int, type:Int, data:DataPointer):Void { lime.jni.Lime.lime_gl_tex_sub_image_3d(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, data); }
	public static inline function lime_gl_transform_feedback_varyings(program:Int, varyings:Dynamic, bufferMode:Int):Void { lime.jni.Lime.lime_gl_transform_feedback_varyings(program, varyings, bufferMode); }
	public static inline function lime_gl_uniform1f(location:Int, v0:Float32):Void { lime.jni.Lime.lime_gl_uniform1f(location, v0); }
	public static inline function lime_gl_uniform1fv(location:Int, count:Int, v:DataPointer):Void { lime.jni.Lime.lime_gl_uniform1fv(location, count, v); }
	public static inline function lime_gl_uniform1i(location:Int, v0:Int):Void { lime.jni.Lime.lime_gl_uniform1i(location, v0); }
	public static inline function lime_gl_uniform1iv(location:Int, count:Int, v:DataPointer):Void { lime.jni.Lime.lime_gl_uniform1iv(location, count, v); }
	public static inline function lime_gl_uniform1ui(location:Int, v0:Int):Void { lime.jni.Lime.lime_gl_uniform1ui(location, v0); }
	public static inline function lime_gl_uniform1uiv(location:Int, count:Int, v:DataPointer):Void { lime.jni.Lime.lime_gl_uniform1uiv(location, count, v); }
	public static inline function lime_gl_uniform2f(location:Int, v0:Float32, v1:Float32):Void { lime.jni.Lime.lime_gl_uniform2f(location, v0, v1); }
	public static inline function lime_gl_uniform2fv(location:Int, count:Int, v:DataPointer):Void { lime.jni.Lime.lime_gl_uniform2fv(location, count, v); }
	public static inline function lime_gl_uniform2i(location:Int, v0:Int, v1:Int):Void { lime.jni.Lime.lime_gl_uniform2i(location, v0, v1); }
	public static inline function lime_gl_uniform2iv(location:Int, count:Int, v:DataPointer):Void { lime.jni.Lime.lime_gl_uniform2iv(location, count, v); }
	public static inline function lime_gl_uniform2ui(location:Int, v0:Int, v1:Int):Void { lime.jni.Lime.lime_gl_uniform2ui(location, v0, v1); }
	public static inline function lime_gl_uniform2uiv(location:Int, count:Int, v:DataPointer):Void { lime.jni.Lime.lime_gl_uniform2uiv(location, count, v); }
	public static inline function lime_gl_uniform3f(location:Int, v0:Float32, v1:Float32, v2:Float32):Void { lime.jni.Lime.lime_gl_uniform3f(location, v0, v1, v2); }
	public static inline function lime_gl_uniform3fv(location:Int, count:Int, v:DataPointer):Void { lime.jni.Lime.lime_gl_uniform3fv(location, count, v); }
	public static inline function lime_gl_uniform3i(location:Int, v0:Int, v1:Int, v2:Int):Void { lime.jni.Lime.lime_gl_uniform3i(location, v0, v1, v2); }
	public static inline function lime_gl_uniform3iv(location:Int, count:Int, v:DataPointer):Void { lime.jni.Lime.lime_gl_uniform3iv(location, count, v); }
	public static inline function lime_gl_uniform3ui(location:Int, v0:Int, v1:Int, v2:Int):Void { lime.jni.Lime.lime_gl_uniform3ui(location, v0, v1, v2); }
	public static inline function lime_gl_uniform3uiv(location:Int, count:Int, v:DataPointer):Void { lime.jni.Lime.lime_gl_uniform3uiv(location, count, v); }
	public static inline function lime_gl_uniform4f(location:Int, v0:Float32, v1:Float32, v2:Float32, v3:Float32):Void { lime.jni.Lime.lime_gl_uniform4f(location, v0, v1, v2, v3); }
	public static inline function lime_gl_uniform4fv(location:Int, count:Int, v:DataPointer):Void { lime.jni.Lime.lime_gl_uniform4fv(location, count, v); }
	public static inline function lime_gl_uniform4i(location:Int, v0:Int, v1:Int, v2:Int, v3:Int):Void { lime.jni.Lime.lime_gl_uniform4i(location, v0, v1, v2, v3); }
	public static inline function lime_gl_uniform4iv(location:Int, count:Int, v:DataPointer):Void { lime.jni.Lime.lime_gl_uniform4iv(location, count, v); }
	public static inline function lime_gl_uniform4ui(location:Int, v0:Int, v1:Int, v2:Int, v3:Int):Void { lime.jni.Lime.lime_gl_uniform4ui(location, v0, v1, v2, v3); }
	public static inline function lime_gl_uniform4uiv(location:Int, count:Int, v:DataPointer):Void { lime.jni.Lime.lime_gl_uniform4uiv(location, count, v); }
	public static inline function lime_gl_uniform_block_binding(program:Int, uniformBlockIndex:Int, uniformBlockBinding:Int):Void { lime.jni.Lime.lime_gl_uniform_block_binding(program, uniformBlockIndex, uniformBlockBinding); }
	public static inline function lime_gl_uniform_matrix2fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void { lime.jni.Lime.lime_gl_uniform_matrix2fv(location, count, transpose, value); }
	public static inline function lime_gl_uniform_matrix2x3fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void { lime.jni.Lime.lime_gl_uniform_matrix2x3fv(location, count, transpose, value); }
	public static inline function lime_gl_uniform_matrix2x4fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void { lime.jni.Lime.lime_gl_uniform_matrix2x4fv(location, count, transpose, value); }
	public static inline function lime_gl_uniform_matrix3fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void { lime.jni.Lime.lime_gl_uniform_matrix3fv(location, count, transpose, value); }
	public static inline function lime_gl_uniform_matrix3x2fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void { lime.jni.Lime.lime_gl_uniform_matrix3x2fv(location, count, transpose, value); }
	public static inline function lime_gl_uniform_matrix3x4fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void { lime.jni.Lime.lime_gl_uniform_matrix3x4fv(location, count, transpose, value); }
	public static inline function lime_gl_uniform_matrix4fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void { lime.jni.Lime.lime_gl_uniform_matrix4fv(location, count, transpose, value); }
	public static inline function lime_gl_uniform_matrix4x2fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void { lime.jni.Lime.lime_gl_uniform_matrix4x2fv(location, count, transpose, value); }
	public static inline function lime_gl_uniform_matrix4x3fv(location:Int, count:Int, transpose:Bool, value:DataPointer):Void { lime.jni.Lime.lime_gl_uniform_matrix4x3fv(location, count, transpose, value); }
	public static inline function lime_gl_unmap_buffer(target:Int):Bool { return lime.jni.Lime.lime_gl_unmap_buffer(target); }
	public static inline function lime_gl_use_program(program:Int):Void { lime.jni.Lime.lime_gl_use_program(program); }
	public static inline function lime_gl_validate_program(program:Int):Void { lime.jni.Lime.lime_gl_validate_program(program); }
	public static inline function lime_gl_vertex_attrib1f(indx:Int, v0:Float32):Void { lime.jni.Lime.lime_gl_vertex_attrib1f(indx, v0); }
	public static inline function lime_gl_vertex_attrib1fv(indx:Int, values:DataPointer):Void { lime.jni.Lime.lime_gl_vertex_attrib1fv(indx, values); }
	public static inline function lime_gl_vertex_attrib2f(indx:Int, v0:Float32, v1:Float32):Void { lime.jni.Lime.lime_gl_vertex_attrib2f(indx, v0, v1); }
	public static inline function lime_gl_vertex_attrib2fv(indx:Int, values:DataPointer):Void { lime.jni.Lime.lime_gl_vertex_attrib2fv(indx, values); }
	public static inline function lime_gl_vertex_attrib3f(indx:Int, v0:Float32, v1:Float32, v2:Float32):Void { lime.jni.Lime.lime_gl_vertex_attrib3f(indx, v0, v1, v2); }
	public static inline function lime_gl_vertex_attrib3fv(indx:Int, values:DataPointer):Void { lime.jni.Lime.lime_gl_vertex_attrib3fv(indx, values); }
	public static inline function lime_gl_vertex_attrib4f(indx:Int, v0:Float32, v1:Float32, v2:Float32, v3:Float32):Void { lime.jni.Lime.lime_gl_vertex_attrib4f(indx, v0, v1, v2, v3); }
	public static inline function lime_gl_vertex_attrib4fv(indx:Int, values:DataPointer):Void { lime.jni.Lime.lime_gl_vertex_attrib4fv(indx, values); }
	public static inline function lime_gl_vertex_attrib_divisor(indx:Int, divisor:Int):Void { lime.jni.Lime.lime_gl_vertex_attrib_divisor(indx, divisor); }
	public static inline function lime_gl_vertex_attrib_ipointer(indx:Int, size:Int, type:Int, stride:Int, offset:DataPointer):Void { lime.jni.Lime.lime_gl_vertex_attrib_ipointer(indx, size, type, stride, offset); }
	public static inline function lime_gl_vertex_attrib_pointer(indx:Int, size:Int, type:Int, normalized:Bool, stride:Int, offset:DataPointer):Void { lime.jni.Lime.lime_gl_vertex_attrib_pointer(indx, size, type, normalized, stride, offset); }
	public static inline function lime_gl_vertex_attribi4i(indx:Int, v0:Int, v1:Int, v2:Int, v3:Int):Void { lime.jni.Lime.lime_gl_vertex_attribi4i(indx, v0, v1, v2, v3); }
	public static inline function lime_gl_vertex_attribi4iv(indx:Int, values:DataPointer):Void { lime.jni.Lime.lime_gl_vertex_attribi4iv(indx, values); }
	public static inline function lime_gl_vertex_attribi4ui(indx:Int, v0:Int, v1:Int, v2:Int, v3:Int):Void { lime.jni.Lime.lime_gl_vertex_attribi4ui(indx, v0, v1, v2, v3); }
	public static inline function lime_gl_vertex_attribi4uiv(indx:Int, values:DataPointer):Void { lime.jni.Lime.lime_gl_vertex_attribi4uiv(indx, values); }
	public static inline function lime_gl_viewport(x:Int, y:Int, width:Int, height:Int):Void { lime.jni.Lime.lime_gl_viewport(x, y, width, height); }
	public static inline function lime_gl_wait_sync(sync:CFFIPointer, flags:Int, timeoutA:Int, timeoutB:Int):Void { lime.jni.Lime.lime_gl_wait_sync(sync, flags, timeoutA, timeoutB); }
	public static inline function lime_gzip_compress(data:Dynamic, bytes:Dynamic):Dynamic { return cast lime.jni.Lime.lime_gzip_compress(data, bytes); }
	public static inline function lime_gzip_decompress(data:Dynamic, bytes:Dynamic):Dynamic { return cast lime.jni.Lime.lime_gzip_decompress(data, bytes); }
	public static inline function lime_haptic_vibrate(period:Int, duration:Int):Void { lime.jni.Lime.lime_haptic_vibrate(period, duration); }
	public static inline function lime_hb_blob_create(data:DataPointer, length:Int, memoryMode:Int):CFFIPointer { return cast lime.jni.Lime.lime_hb_blob_create(data, length, memoryMode); }
	public static inline function lime_hb_blob_create_sub_blob(parent:CFFIPointer, offset:Int, length:Int):CFFIPointer { return cast lime.jni.Lime.lime_hb_blob_create_sub_blob(parent, offset, length); }
	public static inline function lime_hb_blob_get_data(blob:CFFIPointer):Float { return lime.jni.Lime.lime_hb_blob_get_data(blob); }
	public static inline function lime_hb_blob_get_data_writable(blob:CFFIPointer):Float { return lime.jni.Lime.lime_hb_blob_get_data_writable(blob); }
	public static inline function lime_hb_blob_get_empty():CFFIPointer { return cast lime.jni.Lime.lime_hb_blob_get_empty(); }
	public static inline function lime_hb_blob_get_length(blob:CFFIPointer):Int { return lime.jni.Lime.lime_hb_blob_get_length(blob); }
	public static inline function lime_hb_blob_is_immutable(blob:CFFIPointer):Bool { return lime.jni.Lime.lime_hb_blob_is_immutable(blob); }
	public static inline function lime_hb_blob_make_immutable(blob:CFFIPointer):Void { lime.jni.Lime.lime_hb_blob_make_immutable(blob); }
	public static inline function lime_hb_buffer_add(buffer:CFFIPointer, codepoint:Int, cluster:Int):Void { lime.jni.Lime.lime_hb_buffer_add(buffer, codepoint, cluster); }
	public static inline function lime_hb_buffer_add_codepoints(buffer:CFFIPointer, text:DataPointer, textLength:Int, itemOffset:Int, itemLength:Int):Void { lime.jni.Lime.lime_hb_buffer_add_codepoints(buffer, text, textLength, itemOffset, itemLength); }
	public static inline function lime_hb_buffer_add_hxstring(buffer:CFFIPointer, text:String, itemOffset:Int, itemLength:Int):Void { lime.jni.Lime.lime_hb_buffer_add_hxstring(buffer, text, itemOffset, itemLength); }
	public static inline function lime_hb_buffer_add_utf16(buffer:CFFIPointer, text:DataPointer, textLength:Int, itemOffset:Int, itemLength:Int):Void { lime.jni.Lime.lime_hb_buffer_add_utf16(buffer, text, textLength, itemOffset, itemLength); }
	public static inline function lime_hb_buffer_add_utf32(buffer:CFFIPointer, text:DataPointer, textLength:Int, itemOffset:Int, itemLength:Int):Void { lime.jni.Lime.lime_hb_buffer_add_utf32(buffer, text, textLength, itemOffset, itemLength); }
	public static inline function lime_hb_buffer_add_utf8(buffer:CFFIPointer, text:String, itemOffset:Int, itemLength:Int):Void { lime.jni.Lime.lime_hb_buffer_add_utf8(buffer, text, itemOffset, itemLength); }
	public static inline function lime_hb_buffer_allocation_successful(buffer:CFFIPointer):Bool { return lime.jni.Lime.lime_hb_buffer_allocation_successful(buffer); }
	public static inline function lime_hb_buffer_clear_contents(buffer:CFFIPointer):Void { lime.jni.Lime.lime_hb_buffer_clear_contents(buffer); }
	public static inline function lime_hb_buffer_create():CFFIPointer { return cast lime.jni.Lime.lime_hb_buffer_create(); }
	public static inline function lime_hb_buffer_get_cluster_level(buffer:CFFIPointer):Int { return lime.jni.Lime.lime_hb_buffer_get_cluster_level(buffer); }
	public static inline function lime_hb_buffer_get_content_type(buffer:CFFIPointer):Int { return lime.jni.Lime.lime_hb_buffer_get_content_type(buffer); }
	public static inline function lime_hb_buffer_get_direction(buffer:CFFIPointer):Int { return lime.jni.Lime.lime_hb_buffer_get_direction(buffer); }
	public static inline function lime_hb_buffer_get_empty():CFFIPointer { return cast lime.jni.Lime.lime_hb_buffer_get_empty(); }
	public static inline function lime_hb_buffer_get_flags(buffer:CFFIPointer):Int { return lime.jni.Lime.lime_hb_buffer_get_flags(buffer); }
	public static inline function lime_hb_buffer_get_glyph_infos(buffer:CFFIPointer, bytes:Bytes):Bytes { return cast lime.jni.Lime.lime_hb_buffer_get_glyph_infos(buffer, bytes); }
	public static inline function lime_hb_buffer_get_glyph_positions(buffer:CFFIPointer, bytes:Bytes):Bytes { return cast lime.jni.Lime.lime_hb_buffer_get_glyph_positions(buffer, bytes); }
	public static inline function lime_hb_buffer_get_language(buffer:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_hb_buffer_get_language(buffer); }
	public static inline function lime_hb_buffer_get_length(buffer:CFFIPointer):Int { return lime.jni.Lime.lime_hb_buffer_get_length(buffer); }
	public static inline function lime_hb_buffer_get_replacement_codepoint(buffer:CFFIPointer):Int { return lime.jni.Lime.lime_hb_buffer_get_replacement_codepoint(buffer); }
	public static inline function lime_hb_buffer_get_script(buffer:CFFIPointer):Int { return lime.jni.Lime.lime_hb_buffer_get_script(buffer); }
	public static inline function lime_hb_buffer_get_segment_properties(buffer:CFFIPointer, props:CFFIPointer):Void { lime.jni.Lime.lime_hb_buffer_get_segment_properties(buffer, props); }
	public static inline function lime_hb_buffer_guess_segment_properties(buffer:CFFIPointer):Void { lime.jni.Lime.lime_hb_buffer_guess_segment_properties(buffer); }
	public static inline function lime_hb_buffer_normalize_glyphs(buffer:CFFIPointer):Void { lime.jni.Lime.lime_hb_buffer_normalize_glyphs(buffer); }
	public static inline function lime_hb_buffer_preallocate(buffer:CFFIPointer, size:Int):Bool { return lime.jni.Lime.lime_hb_buffer_preallocate(buffer, size); }
	public static inline function lime_hb_buffer_reset(buffer:CFFIPointer):Void { lime.jni.Lime.lime_hb_buffer_reset(buffer); }
	public static inline function lime_hb_buffer_reverse(buffer:CFFIPointer):Void { lime.jni.Lime.lime_hb_buffer_reverse(buffer); }
	public static inline function lime_hb_buffer_reverse_clusters(buffer:CFFIPointer):Void { lime.jni.Lime.lime_hb_buffer_reverse_clusters(buffer); }
	public static inline function lime_hb_buffer_serialize_format_from_string(str:String):Int { return lime.jni.Lime.lime_hb_buffer_serialize_format_from_string(str); }
	public static inline function lime_hb_buffer_serialize_format_to_string(format:Int):CFFIPointer { return cast lime.jni.Lime.lime_hb_buffer_serialize_format_to_string(format); }
	public static inline function lime_hb_buffer_serialize_list_formats():CFFIPointer { return cast lime.jni.Lime.lime_hb_buffer_serialize_list_formats(); }
	public static inline function lime_hb_buffer_set_cluster_level(buffer:CFFIPointer, clusterLevel:Int):Void { lime.jni.Lime.lime_hb_buffer_set_cluster_level(buffer, clusterLevel); }
	public static inline function lime_hb_buffer_set_content_type(buffer:CFFIPointer, contentType:Int):Void { lime.jni.Lime.lime_hb_buffer_set_content_type(buffer, contentType); }
	public static inline function lime_hb_buffer_set_direction(buffer:CFFIPointer, direction:Int):Void { lime.jni.Lime.lime_hb_buffer_set_direction(buffer, direction); }
	public static inline function lime_hb_buffer_set_flags(buffer:CFFIPointer, flags:Int):Void { lime.jni.Lime.lime_hb_buffer_set_flags(buffer, flags); }
	public static inline function lime_hb_buffer_set_language(buffer:CFFIPointer, language:CFFIPointer):Void { lime.jni.Lime.lime_hb_buffer_set_language(buffer, language); }
	public static inline function lime_hb_buffer_set_length(buffer:CFFIPointer, length:Int):Bool { return lime.jni.Lime.lime_hb_buffer_set_length(buffer, length); }
	public static inline function lime_hb_buffer_set_replacement_codepoint(buffer:CFFIPointer, replacement:Int):Void { lime.jni.Lime.lime_hb_buffer_set_replacement_codepoint(buffer, replacement); }
	public static inline function lime_hb_buffer_set_script(buffer:CFFIPointer, script:Int):Void { lime.jni.Lime.lime_hb_buffer_set_script(buffer, script); }
	public static inline function lime_hb_buffer_set_segment_properties(buffer:CFFIPointer, props:CFFIPointer):Void { lime.jni.Lime.lime_hb_buffer_set_segment_properties(buffer, props); }
	public static inline function lime_hb_face_create(blob:CFFIPointer, index:Int):CFFIPointer { return cast lime.jni.Lime.lime_hb_face_create(blob, index); }
	public static inline function lime_hb_face_get_empty():CFFIPointer { return cast lime.jni.Lime.lime_hb_face_get_empty(); }
	public static inline function lime_hb_face_get_glyph_count(face:CFFIPointer):Int { return lime.jni.Lime.lime_hb_face_get_glyph_count(face); }
	public static inline function lime_hb_face_get_index(face:CFFIPointer):Int { return lime.jni.Lime.lime_hb_face_get_index(face); }
	public static inline function lime_hb_face_get_upem(face:CFFIPointer):Int { return lime.jni.Lime.lime_hb_face_get_upem(face); }
	public static inline function lime_hb_face_is_immutable(face:CFFIPointer):Bool { return lime.jni.Lime.lime_hb_face_is_immutable(face); }
	public static inline function lime_hb_face_make_immutable(face:CFFIPointer):Void { lime.jni.Lime.lime_hb_face_make_immutable(face); }
	public static inline function lime_hb_face_reference_blob(face:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_hb_face_reference_blob(face); }
	public static inline function lime_hb_face_reference_table(face:CFFIPointer, tag:Int):CFFIPointer { return cast lime.jni.Lime.lime_hb_face_reference_table(face, tag); }
	public static inline function lime_hb_face_set_glyph_count(face:CFFIPointer, glyphCount:Int):Void { lime.jni.Lime.lime_hb_face_set_glyph_count(face, glyphCount); }
	public static inline function lime_hb_face_set_index(face:CFFIPointer, index:Int):Void { lime.jni.Lime.lime_hb_face_set_index(face, index); }
	public static inline function lime_hb_face_set_upem(face:CFFIPointer, upem:Int):Void { lime.jni.Lime.lime_hb_face_set_upem(face, upem); }
	public static inline function lime_hb_feature_from_string(str:String):CFFIPointer { return cast lime.jni.Lime.lime_hb_feature_from_string(str); }
	public static inline function lime_hb_feature_to_string(feature:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_hb_feature_to_string(feature); }
	public static inline function lime_hb_font_add_glyph_origin_for_direction(font:CFFIPointer, glyph:Int, direction:Int, x:Int, y:Int):Void { lime.jni.Lime.lime_hb_font_add_glyph_origin_for_direction(font, glyph, direction, x, y); }
	public static inline function lime_hb_font_create(face:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_hb_font_create(face); }
	public static inline function lime_hb_font_create_sub_font(parent:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_hb_font_create_sub_font(parent); }
	public static inline function lime_hb_font_get_empty():CFFIPointer { return cast lime.jni.Lime.lime_hb_font_get_empty(); }
	public static inline function lime_hb_font_get_face(font:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_hb_font_get_face(font); }
	public static inline function lime_hb_font_get_glyph_advance_for_direction(font:CFFIPointer, glyph:Int, direction:Int):Dynamic { return cast lime.jni.Lime.lime_hb_font_get_glyph_advance_for_direction(font, glyph, direction); }
	public static inline function lime_hb_font_get_glyph_kerning_for_direction(font:CFFIPointer, firstGlyph:Int, secondGlyph:Int, direction:Int):Dynamic { return cast lime.jni.Lime.lime_hb_font_get_glyph_kerning_for_direction(font, firstGlyph, secondGlyph, direction); }
	public static inline function lime_hb_font_get_glyph_origin_for_direction(font:CFFIPointer, glyph:Int, direction:Int):Dynamic { return cast lime.jni.Lime.lime_hb_font_get_glyph_origin_for_direction(font, glyph, direction); }
	public static inline function lime_hb_font_get_parent(font:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_hb_font_get_parent(font); }
	public static inline function lime_hb_font_get_ppem(font:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_hb_font_get_ppem(font); }
	public static inline function lime_hb_font_get_scale(font:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_hb_font_get_scale(font); }
	public static inline function lime_hb_font_glyph_from_string(font:CFFIPointer, s:String):Int { return lime.jni.Lime.lime_hb_font_glyph_from_string(font, s); }
	public static inline function lime_hb_font_glyph_to_string(font:CFFIPointer, codepoint:Int):CFFIPointer { return cast lime.jni.Lime.lime_hb_font_glyph_to_string(font, codepoint); }
	public static inline function lime_hb_font_is_immutable(font:CFFIPointer):Bool { return lime.jni.Lime.lime_hb_font_is_immutable(font); }
	public static inline function lime_hb_font_make_immutable(font:CFFIPointer):Void { lime.jni.Lime.lime_hb_font_make_immutable(font); }
	public static inline function lime_hb_font_set_ppem(font:CFFIPointer, xppem:Int, yppem:Int):Void { lime.jni.Lime.lime_hb_font_set_ppem(font, xppem, yppem); }
	public static inline function lime_hb_font_set_scale(font:CFFIPointer, xScale:Int, yScale:Int):Void { lime.jni.Lime.lime_hb_font_set_scale(font, xScale, yScale); }
	public static inline function lime_hb_font_subtract_glyph_origin_for_direction(font:CFFIPointer, glyph:Int, direction:Int, x:Int, y:Int):Void { lime.jni.Lime.lime_hb_font_subtract_glyph_origin_for_direction(font, glyph, direction, x, y); }
	public static inline function lime_hb_ft_font_changed(font:CFFIPointer):Void { lime.jni.Lime.lime_hb_ft_font_changed(font); }
	public static inline function lime_hb_ft_font_create(font:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_hb_ft_font_create(font); }
	public static inline function lime_hb_ft_font_create_referenced(font:CFFIPointer):CFFIPointer { return cast lime.jni.Lime.lime_hb_ft_font_create_referenced(font); }
	public static inline function lime_hb_ft_font_get_load_flags(font:CFFIPointer):Int { return lime.jni.Lime.lime_hb_ft_font_get_load_flags(font); }
	public static inline function lime_hb_ft_font_set_load_flags(font:CFFIPointer, loadFlags:Int):Void { lime.jni.Lime.lime_hb_ft_font_set_load_flags(font, loadFlags); }
	public static inline function lime_hb_language_from_string(str:String):CFFIPointer { return cast lime.jni.Lime.lime_hb_language_from_string(str); }
	public static inline function lime_hb_language_get_default():CFFIPointer { return cast lime.jni.Lime.lime_hb_language_get_default(); }
	public static inline function lime_hb_language_to_string(language:CFFIPointer):Dynamic { return cast lime.jni.Lime.lime_hb_language_to_string(language); }
	public static inline function lime_hb_segment_properties_equal(a:CFFIPointer, b:CFFIPointer):Bool { return lime.jni.Lime.lime_hb_segment_properties_equal(a, b); }
	public static inline function lime_hb_segment_properties_hash(p:CFFIPointer):Int { return lime.jni.Lime.lime_hb_segment_properties_hash(p); }
	public static inline function lime_hb_set_add(set:CFFIPointer, codepoint:Int):Void { lime.jni.Lime.lime_hb_set_add(set, codepoint); }
	public static inline function lime_hb_set_add_range(set:CFFIPointer, first:Int, last:Int):Void { lime.jni.Lime.lime_hb_set_add_range(set, first, last); }
	public static inline function lime_hb_set_allocation_successful(set:CFFIPointer):Bool { return lime.jni.Lime.lime_hb_set_allocation_successful(set); }
	public static inline function lime_hb_set_clear(set:CFFIPointer):Void { lime.jni.Lime.lime_hb_set_clear(set); }
	public static inline function lime_hb_set_create():CFFIPointer { return cast lime.jni.Lime.lime_hb_set_create(); }
	public static inline function lime_hb_set_del(set:CFFIPointer, codepoint:Int):Void { lime.jni.Lime.lime_hb_set_del(set, codepoint); }
	public static inline function lime_hb_set_del_range(set:CFFIPointer, first:Int, last:Int):Void { lime.jni.Lime.lime_hb_set_del_range(set, first, last); }
	public static inline function lime_hb_set_get_empty():CFFIPointer { return cast lime.jni.Lime.lime_hb_set_get_empty(); }
	public static inline function lime_hb_set_get_max(set:CFFIPointer):Int { return lime.jni.Lime.lime_hb_set_get_max(set); }
	public static inline function lime_hb_set_get_min(set:CFFIPointer):Int { return lime.jni.Lime.lime_hb_set_get_min(set); }
	public static inline function lime_hb_set_get_population(set:CFFIPointer):Int { return lime.jni.Lime.lime_hb_set_get_population(set); }
	public static inline function lime_hb_set_has(set:CFFIPointer, codepoint:Int):Bool { return lime.jni.Lime.lime_hb_set_has(set, codepoint); }
	public static inline function lime_hb_set_intersect(set:CFFIPointer, other:CFFIPointer):Void { lime.jni.Lime.lime_hb_set_intersect(set, other); }
	public static inline function lime_hb_set_invert(set:CFFIPointer):Void { lime.jni.Lime.lime_hb_set_invert(set); }
	public static inline function lime_hb_set_is_empty(set:CFFIPointer):Bool { return lime.jni.Lime.lime_hb_set_is_empty(set); }
	public static inline function lime_hb_set_is_equal(set:CFFIPointer, other:CFFIPointer):Bool { return lime.jni.Lime.lime_hb_set_is_equal(set, other); }
	public static inline function lime_hb_set_next(set:CFFIPointer):Int { return lime.jni.Lime.lime_hb_set_next(set); }
	public static inline function lime_hb_set_next_range(set:CFFIPointer):Dynamic { return cast lime.jni.Lime.lime_hb_set_next_range(set); }
	public static inline function lime_hb_set_set(set:CFFIPointer, other:CFFIPointer):Void { lime.jni.Lime.lime_hb_set_set(set, other); }
	public static inline function lime_hb_set_subtract(set:CFFIPointer, other:CFFIPointer):Void { lime.jni.Lime.lime_hb_set_subtract(set, other); }
	public static inline function lime_hb_set_symmetric_difference(set:CFFIPointer, other:CFFIPointer):Void { lime.jni.Lime.lime_hb_set_symmetric_difference(set, other); }
	public static inline function lime_hb_set_union(set:CFFIPointer, other:CFFIPointer):Void { lime.jni.Lime.lime_hb_set_union(set, other); }
	public static inline function lime_hb_shape(font:CFFIPointer, buffer:CFFIPointer, features:Dynamic):Void { lime.jni.Lime.lime_hb_shape(font, buffer, features); }
	public static inline function lime_image_data_util_color_transform(image:Dynamic, rect:Dynamic, colorMatrix:Dynamic):Void { lime.jni.Lime.lime_image_data_util_color_transform(image, rect, colorMatrix); }
	public static inline function lime_image_data_util_copy_channel(image:Dynamic, sourceImage:Dynamic, sourceRect:Dynamic, destPoint:Dynamic, srcChannel:Int, destChannel:Int):Void { lime.jni.Lime.lime_image_data_util_copy_channel(image, sourceImage, sourceRect, destPoint, srcChannel, destChannel); }
	public static inline function lime_image_data_util_copy_pixels(image:Dynamic, sourceImage:Dynamic, sourceRect:Dynamic, destPoint:Dynamic, alphaImage:Dynamic, alphaPoint:Dynamic, mergeAlpha:Bool):Void { lime.jni.Lime.lime_image_data_util_copy_pixels(image, sourceImage, sourceRect, destPoint, alphaImage, alphaPoint, mergeAlpha); }
	public static inline function lime_image_data_util_fill_rect(image:Dynamic, rect:Dynamic, rg:Int, ba:Int):Void { lime.jni.Lime.lime_image_data_util_fill_rect(image, rect, rg, ba); }
	public static inline function lime_image_data_util_flood_fill(image:Dynamic, x:Int, y:Int, rg:Int, ba:Int):Void { lime.jni.Lime.lime_image_data_util_flood_fill(image, x, y, rg, ba); }
	public static inline function lime_image_data_util_get_pixels(image:Dynamic, rect:Dynamic, format:Int, bytes:Dynamic):Void { lime.jni.Lime.lime_image_data_util_get_pixels(image, rect, format, bytes); }
	public static inline function lime_image_data_util_merge(image:Dynamic, sourceImage:Dynamic, sourceRect:Dynamic, destPoint:Dynamic, redMultiplier:Int, greenMultiplier:Int, blueMultiplier:Int, alphaMultiplier:Int):Void { lime.jni.Lime.lime_image_data_util_merge(image, sourceImage, sourceRect, destPoint, redMultiplier, greenMultiplier, blueMultiplier, alphaMultiplier); }
	public static inline function lime_image_data_util_multiply_alpha(image:Dynamic):Void { lime.jni.Lime.lime_image_data_util_multiply_alpha(image); }
	public static inline function lime_image_data_util_resize(image:Dynamic, buffer:Dynamic, width:Int, height:Int):Void { lime.jni.Lime.lime_image_data_util_resize(image, buffer, width, height); }
	public static inline function lime_image_data_util_set_format(image:Dynamic, format:Int):Void { lime.jni.Lime.lime_image_data_util_set_format(image, format); }
	public static inline function lime_image_data_util_set_pixels(image:Dynamic, rect:Dynamic, bytes:Dynamic, offset:Int, format:Int, endian:Int):Void { lime.jni.Lime.lime_image_data_util_set_pixels(image, rect, bytes, offset, format, endian); }
	public static inline function lime_image_data_util_threshold(image:Dynamic, sourceImage:Dynamic, sourceRect:Dynamic, destPoint:Dynamic, operation:Int, thresholdRG:Int, thresholdBA:Int, colorRG:Int, colorBA:Int, maskRG:Int, maskBA:Int, copySource:Bool):Int { return lime.jni.Lime.lime_image_data_util_threshold(image, sourceImage, sourceRect, destPoint, operation, thresholdRG, thresholdBA, colorRG, colorBA, maskRG, maskBA, copySource); }
	public static inline function lime_image_data_util_unmultiply_alpha(image:Dynamic):Void { lime.jni.Lime.lime_image_data_util_unmultiply_alpha(image); }
	public static inline function lime_image_encode(data:Dynamic, type:Int, quality:Int, bytes:Dynamic):Dynamic { return cast lime.jni.Lime.lime_image_encode(data, type, quality, bytes); }
	public static inline function lime_image_load(data:Dynamic, buffer:Dynamic):Dynamic { return cast lime.jni.Lime.lime_image_load(data, buffer); }
	public static inline function lime_image_load_bytes(data:Dynamic, buffer:Dynamic):Dynamic { return cast lime.jni.Lime.lime_image_load_bytes(data, buffer); }
	public static inline function lime_image_load_file(path:Dynamic, buffer:Dynamic):Dynamic { return cast lime.jni.Lime.lime_image_load_file(path, buffer); }
	public static inline function lime_jni_call_member(jniMethod:Dynamic, jniObject:Dynamic, args:Dynamic):Dynamic { return cast lime.jni.Lime.lime_jni_call_member(jniMethod, jniObject, args); }
	public static inline function lime_jni_call_static(jniMethod:Dynamic, args:Dynamic):Dynamic { return cast lime.jni.Lime.lime_jni_call_static(jniMethod, args); }
	public static inline function lime_jni_create_field(className:String, field:String, signature:String, isStatic:Bool):Dynamic { return cast lime.jni.Lime.lime_jni_create_field(className, field, signature, isStatic); }
	public static inline function lime_jni_create_method(className:String, method:String, signature:String, isStatic:Bool, quiet:Bool):Dynamic { return cast lime.jni.Lime.lime_jni_create_method(className, method, signature, isStatic, quiet); }
	public static inline function lime_jni_get_env():Float { return lime.jni.Lime.lime_jni_get_env(); }
	public static inline function lime_jni_get_member(jniField:Dynamic, jniObject:Dynamic):Dynamic { return cast lime.jni.Lime.lime_jni_get_member(jniField, jniObject); }
	public static inline function lime_jni_get_static(jniField:Dynamic):Dynamic { return cast lime.jni.Lime.lime_jni_get_static(jniField); }
	public static inline function lime_jni_post_ui_callback(callback:Dynamic):Void { lime.jni.Lime.lime_jni_post_ui_callback(callback); }
	public static inline function lime_jni_set_member(jniField:Dynamic, jniObject:Dynamic, value:Dynamic):Void { lime.jni.Lime.lime_jni_set_member(jniField, jniObject, value); }
	public static inline function lime_jni_set_static(jniField:Dynamic, value:Dynamic):Void { lime.jni.Lime.lime_jni_set_static(jniField, value); }
	public static inline function lime_joystick_event_manager_register(callback:Dynamic, eventObject:Dynamic):Void { lime.jni.Lime.lime_joystick_event_manager_register(callback, eventObject); }
	public static inline function lime_joystick_get_device_guid(id:Int):Dynamic { return cast lime.jni.Lime.lime_joystick_get_device_guid(id); }
	public static inline function lime_joystick_get_device_name(id:Int):Dynamic { return cast lime.jni.Lime.lime_joystick_get_device_name(id); }
	public static inline function lime_joystick_get_num_axes(id:Int):Int { return lime.jni.Lime.lime_joystick_get_num_axes(id); }
	public static inline function lime_joystick_get_num_buttons(id:Int):Int { return lime.jni.Lime.lime_joystick_get_num_buttons(id); }
	public static inline function lime_joystick_get_num_hats(id:Int):Int { return lime.jni.Lime.lime_joystick_get_num_hats(id); }
	public static inline function lime_jpeg_decode_bytes(data:Dynamic, decodeData:Bool, buffer:Dynamic):Dynamic { return cast lime.jni.Lime.lime_jpeg_decode_bytes(data, decodeData, buffer); }
	public static inline function lime_jpeg_decode_file(path:String, decodeData:Bool, buffer:Dynamic):Dynamic { return cast lime.jni.Lime.lime_jpeg_decode_file(path, decodeData, buffer); }
	public static inline function lime_key_code_from_scan_code(scanCode:Int):Int { return lime.jni.Lime.lime_key_code_from_scan_code(scanCode); }
	public static inline function lime_key_code_to_scan_code(keyCode:Int):Int { return lime.jni.Lime.lime_key_code_to_scan_code(keyCode); }
	public static inline function lime_key_event_manager_register(callback:Dynamic, eventObject:Dynamic):Void { lime.jni.Lime.lime_key_event_manager_register(callback, eventObject); }
	public static inline function lime_lzma_compress(data:Dynamic, bytes:Dynamic):Dynamic { return cast lime.jni.Lime.lime_lzma_compress(data, bytes); }
	public static inline function lime_lzma_decompress(data:Dynamic, bytes:Dynamic):Dynamic { return cast lime.jni.Lime.lime_lzma_decompress(data, bytes); }
	public static inline function lime_mouse_event_manager_register(callback:Dynamic, eventObject:Dynamic):Void { lime.jni.Lime.lime_mouse_event_manager_register(callback, eventObject); }
	public static inline function lime_neko_execute(module:String):Void { lime.jni.Lime.lime_neko_execute(module); }
	public static inline function lime_orientation_event_manager_register(callback:Dynamic, eventObject:Dynamic):Void { lime.jni.Lime.lime_orientation_event_manager_register(callback, eventObject); }
	public static inline function lime_png_decode_bytes(data:Dynamic, decodeData:Bool, buffer:Dynamic):Dynamic { return cast lime.jni.Lime.lime_png_decode_bytes(data, decodeData, buffer); }
	public static inline function lime_png_decode_file(path:String, decodeData:Bool, buffer:Dynamic):Dynamic { return cast lime.jni.Lime.lime_png_decode_file(path, decodeData, buffer); }
	public static inline function lime_render_event_manager_register(callback:Dynamic, eventObject:Dynamic):Void { lime.jni.Lime.lime_render_event_manager_register(callback, eventObject); }
	public static inline function lime_sdl_sound_get_info_from_bytes(bytes:Dynamic):Dynamic { return cast lime.jni.Lime.lime_sdl_sound_get_info_from_bytes(bytes); }
	public static inline function lime_sdl_sound_get_info_from_file(path:String):Dynamic { return cast lime.jni.Lime.lime_sdl_sound_get_info_from_file(path); }
	public static inline function lime_sdl_sound_stream_clear(stream:CFFIPointer):Void { lime.jni.Lime.lime_sdl_sound_stream_clear(stream); }
	public static inline function lime_sdl_sound_stream_from_bytes(bytes:Dynamic):CFFIPointer { return cast lime.jni.Lime.lime_sdl_sound_stream_from_bytes(bytes); }
	public static inline function lime_sdl_sound_stream_from_file(path:String):CFFIPointer { return cast lime.jni.Lime.lime_sdl_sound_stream_from_file(path); }
	public static inline function lime_sdl_sound_stream_read(stream:CFFIPointer, buffer:Dynamic, length:Int):Int { return lime.jni.Lime.lime_sdl_sound_stream_read(stream, buffer, length); }
	public static inline function lime_sdl_sound_stream_rewind(stream:CFFIPointer):Bool { return lime.jni.Lime.lime_sdl_sound_stream_rewind(stream); }
	public static inline function lime_sdl_sound_stream_seek(stream:CFFIPointer, ms:Int):Bool { return lime.jni.Lime.lime_sdl_sound_stream_seek(stream, ms); }
	public static inline function lime_sensor_event_manager_register(callback:Dynamic, eventObject:Dynamic):Void { lime.jni.Lime.lime_sensor_event_manager_register(callback, eventObject); }
	public static inline function lime_system_get_allow_screen_timeout():Bool { return lime.jni.Lime.lime_system_get_allow_screen_timeout(); }
	public static inline function lime_system_get_device_model():Dynamic { return cast lime.jni.Lime.lime_system_get_device_model(); }
	public static inline function lime_system_get_device_orientation():Int { return lime.jni.Lime.lime_system_get_device_orientation(); }
	public static inline function lime_system_get_device_vendor():Dynamic { return cast lime.jni.Lime.lime_system_get_device_vendor(); }
	public static inline function lime_system_get_directory(type:Int, company:String, title:String):Dynamic { return cast lime.jni.Lime.lime_system_get_directory(type, company, title); }
	public static inline function lime_system_get_display(index:Int):Dynamic { return cast lime.jni.Lime.lime_system_get_display(index); }
	public static inline function lime_jvm_screen_width():Int { return lime.jni.Lime.lime_jvm_screen_width(); }
	public static inline function lime_jvm_screen_height():Int { return lime.jni.Lime.lime_jvm_screen_height(); }
	public static inline function lime_system_get_ios_tablet():Bool { return lime.jni.Lime.lime_system_get_ios_tablet(); }
	public static inline function lime_system_get_num_displays():Int { return lime.jni.Lime.lime_system_get_num_displays(); }
	public static inline function lime_system_get_platform_label():Dynamic { return cast lime.jni.Lime.lime_system_get_platform_label(); }
	public static inline function lime_system_get_platform_name():Dynamic { return cast lime.jni.Lime.lime_system_get_platform_name(); }
	public static inline function lime_system_get_platform_version():Dynamic { return cast lime.jni.Lime.lime_system_get_platform_version(); }
	public static inline function lime_system_get_timer():Float { return lime.jni.Lime.lime_system_get_timer(); }
	public static inline function lime_system_open_file(path:String):Void { lime.jni.Lime.lime_system_open_file(path); }
	public static inline function lime_system_open_url(url:String, target:String):Void { lime.jni.Lime.lime_system_open_url(url, target); }
	public static inline function lime_system_set_allow_screen_timeout(value:Bool):Bool { return lime.jni.Lime.lime_system_set_allow_screen_timeout(value); }
	public static inline function lime_text_event_manager_register(callback:Dynamic, eventObject:Dynamic):Void { lime.jni.Lime.lime_text_event_manager_register(callback, eventObject); }
	public static inline function lime_touch_event_manager_register(callback:Dynamic, eventObject:Dynamic):Void { lime.jni.Lime.lime_touch_event_manager_register(callback, eventObject); }
	public static inline function lime_vorbis_file_bitrate(vorbisFile:Dynamic, bitstream:Int):Int { return lime.jni.Lime.lime_vorbis_file_bitrate(vorbisFile, bitstream); }
	public static inline function lime_vorbis_file_bitrate_instant(vorbisFile:Dynamic):Int { return lime.jni.Lime.lime_vorbis_file_bitrate_instant(vorbisFile); }
	public static inline function lime_vorbis_file_clear(vorbisFile:Dynamic):Void { lime.jni.Lime.lime_vorbis_file_clear(vorbisFile); }
	public static inline function lime_vorbis_file_comment(vorbisFile:Dynamic, bitstream:Int):Dynamic { return cast lime.jni.Lime.lime_vorbis_file_comment(vorbisFile, bitstream); }
	public static inline function lime_vorbis_file_crosslap(vorbisFile:Dynamic, otherVorbisFile:Dynamic):Dynamic { return cast lime.jni.Lime.lime_vorbis_file_crosslap(vorbisFile, otherVorbisFile); }
	public static inline function lime_vorbis_file_from_bytes(bytes:Dynamic):Dynamic { return cast lime.jni.Lime.lime_vorbis_file_from_bytes(bytes); }
	public static inline function lime_vorbis_file_from_file(path:String):Dynamic { return cast lime.jni.Lime.lime_vorbis_file_from_file(path); }
	public static inline function lime_vorbis_file_info(vorbisFile:Dynamic, bitstream:Int):Dynamic { return cast lime.jni.Lime.lime_vorbis_file_info(vorbisFile, bitstream); }
	public static inline function lime_vorbis_file_pcm_seek(vorbisFile:Dynamic, posLow:Dynamic, posHigh:Dynamic):Int { return lime.jni.Lime.lime_vorbis_file_pcm_seek(vorbisFile, posLow, posHigh); }
	public static inline function lime_vorbis_file_pcm_seek_lap(vorbisFile:Dynamic, posLow:Dynamic, posHigh:Dynamic):Int { return lime.jni.Lime.lime_vorbis_file_pcm_seek_lap(vorbisFile, posLow, posHigh); }
	public static inline function lime_vorbis_file_pcm_seek_page(vorbisFile:Dynamic, posLow:Dynamic, posHigh:Dynamic):Int { return lime.jni.Lime.lime_vorbis_file_pcm_seek_page(vorbisFile, posLow, posHigh); }
	public static inline function lime_vorbis_file_pcm_seek_page_lap(vorbisFile:Dynamic, posLow:Dynamic, posHigh:Dynamic):Int { return lime.jni.Lime.lime_vorbis_file_pcm_seek_page_lap(vorbisFile, posLow, posHigh); }
	public static inline function lime_vorbis_file_pcm_tell(vorbisFile:Dynamic):Dynamic { return cast lime.jni.Lime.lime_vorbis_file_pcm_tell(vorbisFile); }
	public static inline function lime_vorbis_file_pcm_total(vorbisFile:Dynamic, bitstream:Int):Dynamic { return cast lime.jni.Lime.lime_vorbis_file_pcm_total(vorbisFile, bitstream); }
	public static inline function lime_vorbis_file_raw_seek(vorbisFile:Dynamic, posLow:Dynamic, posHigh:Dynamic):Int { return lime.jni.Lime.lime_vorbis_file_raw_seek(vorbisFile, posLow, posHigh); }
	public static inline function lime_vorbis_file_raw_seek_lap(vorbisFile:Dynamic, posLow:Dynamic, posHigh:Dynamic):Int { return lime.jni.Lime.lime_vorbis_file_raw_seek_lap(vorbisFile, posLow, posHigh); }
	public static inline function lime_vorbis_file_raw_tell(vorbisFile:Dynamic):Dynamic { return cast lime.jni.Lime.lime_vorbis_file_raw_tell(vorbisFile); }
	public static inline function lime_vorbis_file_raw_total(vorbisFile:Dynamic, bitstream:Int):Dynamic { return cast lime.jni.Lime.lime_vorbis_file_raw_total(vorbisFile, bitstream); }
	public static inline function lime_vorbis_file_read(vorbisFile:Dynamic, buffer:Dynamic, position:Int, length:Int, bigendianp:Bool, word:Int, signed:Bool):Dynamic { return cast lime.jni.Lime.lime_vorbis_file_read(vorbisFile, buffer, position, length, bigendianp, word, signed); }
	public static inline function lime_vorbis_file_read_float(vorbisFile:Dynamic, pcmChannels:Dynamic, samples:Int):Dynamic { return cast lime.jni.Lime.lime_vorbis_file_read_float(vorbisFile, pcmChannels, samples); }
	public static inline function lime_vorbis_file_seekable(vorbisFile:Dynamic):Bool { return lime.jni.Lime.lime_vorbis_file_seekable(vorbisFile); }
	public static inline function lime_vorbis_file_serial_number(vorbisFile:Dynamic, bitstream:Int):Int { return lime.jni.Lime.lime_vorbis_file_serial_number(vorbisFile, bitstream); }
	public static inline function lime_vorbis_file_streams(vorbisFile:Dynamic):Int { return lime.jni.Lime.lime_vorbis_file_streams(vorbisFile); }
	public static inline function lime_vorbis_file_time_seek(vorbisFile:Dynamic, s:Float):Int { return lime.jni.Lime.lime_vorbis_file_time_seek(vorbisFile, s); }
	public static inline function lime_vorbis_file_time_seek_lap(vorbisFile:Dynamic, s:Float):Int { return lime.jni.Lime.lime_vorbis_file_time_seek_lap(vorbisFile, s); }
	public static inline function lime_vorbis_file_time_seek_page(vorbisFile:Dynamic, s:Float):Int { return lime.jni.Lime.lime_vorbis_file_time_seek_page(vorbisFile, s); }
	public static inline function lime_vorbis_file_time_seek_page_lap(vorbisFile:Dynamic, s:Float):Int { return lime.jni.Lime.lime_vorbis_file_time_seek_page_lap(vorbisFile, s); }
	public static inline function lime_vorbis_file_time_tell(vorbisFile:Dynamic):Float { return lime.jni.Lime.lime_vorbis_file_time_tell(vorbisFile); }
	public static inline function lime_vorbis_file_time_total(vorbisFile:Dynamic, bitstream:Int):Float { return lime.jni.Lime.lime_vorbis_file_time_total(vorbisFile, bitstream); }
	public static inline function lime_window_alert(handle:Dynamic, message:String, title:String):Void { lime.jni.Lime.lime_window_alert(handle, message, title); }
	public static inline function lime_window_close(handle:Dynamic):Void { lime.jni.Lime.lime_window_close(handle); }
	public static inline function lime_window_context_flip(handle:Dynamic):Void { lime.jni.Lime.lime_window_context_flip(handle); }
	public static inline function lime_window_context_lock(handle:Dynamic):Dynamic { return cast lime.jni.Lime.lime_window_context_lock(handle); }
	public static inline function lime_window_context_make_current(handle:Dynamic):Void { lime.jni.Lime.lime_window_context_make_current(handle); }
	public static inline function lime_window_context_unlock(handle:Dynamic):Void { lime.jni.Lime.lime_window_context_unlock(handle); }
	public static inline function lime_window_create(application:Dynamic, width:Int, height:Int, flags:Int, title:String):Dynamic { return cast lime.jni.Lime.lime_window_create(application, width, height, flags, title); }
	public static inline function lime_window_event_manager_register(callback:Dynamic, eventObject:Dynamic):Void { lime.jni.Lime.lime_window_event_manager_register(callback, eventObject); }
	public static inline function lime_window_focus(handle:Dynamic):Void { lime.jni.Lime.lime_window_focus(handle); }
	public static inline function lime_window_get_context(handle:Dynamic):Float { return lime.jni.Lime.lime_window_get_context(handle); }
	public static inline function lime_window_get_context_type(handle:Dynamic):Dynamic { return cast lime.jni.Lime.lime_window_get_context_type(handle); }
	public static inline function lime_window_get_display(handle:Dynamic):Int { return lime.jni.Lime.lime_window_get_display(handle); }
	public static inline function lime_window_get_display_mode(handle:Dynamic):Dynamic { return cast lime.jni.Lime.lime_window_get_display_mode(handle); }
	public static inline function lime_window_get_height(handle:Dynamic):Int { return lime.jni.Lime.lime_window_get_height(handle); }
	public static inline function lime_window_get_id(handle:Dynamic):Int { return lime.jni.Lime.lime_window_get_id(handle); }
	public static inline function lime_window_get_mouse_lock(handle:Dynamic):Bool { return lime.jni.Lime.lime_window_get_mouse_lock(handle); }
	public static inline function lime_window_get_opacity(handle:Dynamic):Float { return lime.jni.Lime.lime_window_get_opacity(handle); }
	public static inline function lime_window_get_scale(handle:Dynamic):Float { return lime.jni.Lime.lime_window_get_scale(handle); }
	public static inline function lime_window_get_text_input_enabled(handle:Dynamic):Bool { return lime.jni.Lime.lime_window_get_text_input_enabled(handle); }
	public static inline function lime_window_get_width(handle:Dynamic):Int { return lime.jni.Lime.lime_window_get_width(handle); }
	public static inline function lime_window_get_x(handle:Dynamic):Int { return lime.jni.Lime.lime_window_get_x(handle); }
	public static inline function lime_window_get_y(handle:Dynamic):Int { return lime.jni.Lime.lime_window_get_y(handle); }
	public static inline function lime_window_move(handle:Dynamic, x:Int, y:Int):Void { lime.jni.Lime.lime_window_move(handle, x, y); }
	public static inline function lime_window_read_pixels(handle:Dynamic, rect:Dynamic, imageBuffer:Dynamic):Dynamic { return cast lime.jni.Lime.lime_window_read_pixels(handle, rect, imageBuffer); }
	public static inline function lime_window_resize(handle:Dynamic, width:Int, height:Int):Void { lime.jni.Lime.lime_window_resize(handle, width, height); }
	public static inline function lime_window_set_always_on_top(handle:Dynamic, alwaysOnTop:Bool):Bool { return lime.jni.Lime.lime_window_set_always_on_top(handle, alwaysOnTop); }
	public static inline function lime_window_set_borderless(handle:Dynamic, borderless:Bool):Bool { return lime.jni.Lime.lime_window_set_borderless(handle, borderless); }
	public static inline function lime_window_set_cursor(handle:Dynamic, cursor:Int):Void { lime.jni.Lime.lime_window_set_cursor(handle, cursor); }
	public static inline function lime_window_set_display_mode(handle:Dynamic, displayMode:Dynamic):Dynamic { return cast lime.jni.Lime.lime_window_set_display_mode(handle, displayMode); }
	public static inline function lime_window_set_fullscreen(handle:Dynamic, fullscreen:Bool):Bool { return lime.jni.Lime.lime_window_set_fullscreen(handle, fullscreen); }
	public static inline function lime_window_set_icon(handle:Dynamic, buffer:Dynamic):Void { lime.jni.Lime.lime_window_set_icon(handle, buffer); }
	public static inline function lime_window_set_maximized(handle:Dynamic, maximized:Bool):Bool { return lime.jni.Lime.lime_window_set_maximized(handle, maximized); }
	public static inline function lime_window_set_maximum_size(handle:Dynamic, width:Int, height:Int):Void { lime.jni.Lime.lime_window_set_maximum_size(handle, width, height); }
	public static inline function lime_window_set_minimized(handle:Dynamic, minimized:Bool):Bool { return lime.jni.Lime.lime_window_set_minimized(handle, minimized); }
	public static inline function lime_window_set_minimum_size(handle:Dynamic, width:Int, height:Int):Void { lime.jni.Lime.lime_window_set_minimum_size(handle, width, height); }
	public static inline function lime_window_set_mouse_lock(handle:Dynamic, mouseLock:Bool):Void { lime.jni.Lime.lime_window_set_mouse_lock(handle, mouseLock); }
	public static inline function lime_window_set_opacity(handle:Dynamic, value:Float):Void { lime.jni.Lime.lime_window_set_opacity(handle, value); }
	public static inline function lime_window_set_resizable(handle:Dynamic, resizable:Bool):Bool { return lime.jni.Lime.lime_window_set_resizable(handle, resizable); }
	public static inline function lime_window_set_text_input_enabled(handle:Dynamic, enabled:Bool):Void { lime.jni.Lime.lime_window_set_text_input_enabled(handle, enabled); }
	public static inline function lime_window_set_text_input_rect(handle:Dynamic, rect:Dynamic):Void { lime.jni.Lime.lime_window_set_text_input_rect(handle, rect); }
	public static inline function lime_window_set_title(handle:Dynamic, title:String):Dynamic { return cast lime.jni.Lime.lime_window_set_title(handle, title); }
	public static inline function lime_window_set_visible(handle:Dynamic, visible:Bool):Bool { return lime.jni.Lime.lime_window_set_visible(handle, visible); }
	public static inline function lime_window_warp_mouse(handle:Dynamic, x:Int, y:Int):Void { lime.jni.Lime.lime_window_warp_mouse(handle, x, y); }
	public static inline function lime_zlib_compress(data:Dynamic, bytes:Dynamic):Dynamic { return cast lime.jni.Lime.lime_zlib_compress(data, bytes); }
	public static inline function lime_zlib_decompress(data:Dynamic, bytes:Dynamic):Dynamic { return cast lime.jni.Lime.lime_zlib_decompress(data, bytes); }
	#end
	//<<JNI_FORWARDERS_END>>
	#if (lime_cffi && !macro)
	#if (cpp && !cppia && !lime_jni)
